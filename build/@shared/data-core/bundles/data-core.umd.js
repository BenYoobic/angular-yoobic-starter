(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/common/http'), require('ng2-file-upload'), require('@auth0/angular-jwt'), require('xlsx'), require('file-saver'), require('papaparse'), require('@ionic-native/file-transfer/ngx'), require('@ionic-native/document-viewer/ngx'), require('@ionic-native/device/ngx'), require('@ionic-native/file/ngx'), require('@ionic-native/file-opener/ngx'), require('@ionic-native/onesignal/ngx'), require('@ionic-native/push/ngx'), require('@shared/common'), require('@shared/translate'), require('@shared/stencil'), require('@angular/core'), require('rxjs'), require('rxjs/operators'), require('lodash-es')) :
    typeof define === 'function' && define.amd ? define('data-core', ['exports', '@angular/common/http', 'ng2-file-upload', '@auth0/angular-jwt', 'xlsx', 'file-saver', 'papaparse', '@ionic-native/file-transfer/ngx', '@ionic-native/document-viewer/ngx', '@ionic-native/device/ngx', '@ionic-native/file/ngx', '@ionic-native/file-opener/ngx', '@ionic-native/onesignal/ngx', '@ionic-native/push/ngx', '@shared/common', '@shared/translate', '@shared/stencil', '@angular/core', 'rxjs', 'rxjs/operators', 'lodash-es'], factory) :
    (factory((global['data-core'] = {}),global.ng.common.http,global.ng2FileUpload,global.angularJWT,global.xlsx,global.FileSaver,global.papaparse,global.FileTransfer,global.DocumentViewer,global.Device,global.File,global.FileOpener,global.Onesignal,global.Push,global['@shared/common'],global['@shared/translate'],global.DesignSystem,global.ng.core,global.rxjs,global.rxjs.operators,global['lodash-es']));
}(this, (function (exports,http,ng2FileUpload,angularJwt,XLSX,saveAs,papaparse,ngx,ngx$1,ngx$2,ngx$3,ngx$4,ngx$5,ngx$6,common,translate,stencil,core,rxjs,operators,lodashEs) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var Config = /** @class */ (function () {
        function Config(localStorage, coreConfig, translate$$1) {
        ...
        Config.ctorParameters = function () {
            return [
                { type: common.LocalStorage },
                { type: common.CoreConfig },
    ...
    var Session = /** @class */ (function () {
        ...
        /** @nocollapse */
        Session.ctorParameters = function () {
            return [
                { type: common.LocalForageService },
                { type: Config }
            ];
        };
        __decorate([
            common.Persistent('login.hideWalkthrough'),
            __metadata("design:type", Boolean)
        ], Session.prototype, "hideWalkthrough", void 0);
        __decorate([
            common.Persistent('badges'),
            __metadata("design:type", Object)
        ], Session.prototype, "localPendingBadges", void 0);
        __decorate([
            common.Persistent('debugEvent'),
            __metadata("design:type", Boolean)
    ...
    var LoadingBar = /** @class */ (function () {
        function LoadingBar() {
            ...
            this.observable = new rxjs.Observable(( /**
             * @param {?} subscriber
             * @return {?}
             */function (subscriber) {
    ...
    var Requestor = /** @class */ (function () {
        function Requestor(http$$1, session, config, loadingBar, coreConfig) {
            this.http = http$$1;
         ...
         */
            function (url, body, token, withCount, isTempToken, looseCount, partialUrl) {
                ...
                if (isTempToken === void 0) {
                    isTempToken = false;
                }
                if (looseCount === void 0) {
                    looseCount = false;
                }
                if (partialUrl === void 0) {
                    partialUrl = false;
                }
                this.slimbarStart();
                if (partialUrl) {
         ...
         */
            function (e, url) {
                ...
                if (e.status === 401 && url && url.indexOf(this.config.serverUrl) >= 0 && !isInvalidCredentials && url.indexOf('getCampaignScore') < 0 && e.error && e.error.error && e.error.error.name && e.error.error.name.toUpperCase() === 'LOGOUT') {
                    ...
                    return rxjs.of(new http.HttpResponse(( /** @type {?} */({ body: {}, status: 404 }))));
                } //else {
                throw e;
                //}
        ...
        Requestor.unauthorizedEmitter = new core.EventEmitter();
        Requestor.payloadTooBigEmitter = new core.EventEmitter();
        Requestor.decorators = [
            { type: core.Injectable }
        ];
        /** @nocollapse */
        Requestor.ctorParameters = function () {
            return [
    ...
    var Algorithms = /** @class */ (function () {
         ...
         */
            function (imageUrl, algorithmId) {
                ...
                return this.rq.post(url, { image_url: imageUrl, algorithm_id: algorithmId }).pipe(operators.catchError(( /**
                 * @param {?} err
                 * @return {?}
                 */function (err) {
         ...
         */
            function (imageUrls, algorithmId) {
                /** @type {?} */
                var url = this.config.apiUrl + 'algorithm/process';
                return this.rq.post(url, { image_url: imageUrls, algorithm_id: algorithmId }).pipe(operators.catchError(( /**
                 * @param {?} err
                 * @return {?}
                 */function (err) {
                    return rxjs.throwError(err);
        ...
        /** @nocollapse */
        Algorithms.ctorParameters = function () {
            return [
                { type: Config },
                { type: Requestor }
            ];
    ...
    var Cache = /** @class */ (function () {
         ...
         */
            function (cacheKey, entryKey) {
                return rxjs.from(this.localForage.get(cacheKey).then(( /**
                 * @param {?} data
                 * @return {?}
                 */function (data) {
                    data = data || {};
         ...
         */
            function (collectionName, entity, patch, idField) {
                ...
                entity[idField] = entity[idField] || Cache.OFFLINE_PREFIX + stencil.getUUID();
    ...
    var IModel = /** @class */ (function () {
        ...
        Object.defineProperty(IModel.prototype, "formFields", {
             ...
             * @return {?}
             */ function () {
                return lodashEs.cloneDeep(this._formFields);
            },
            set: /**
             * @param {?} f
             * @return {?}
    ...
    var Models = /** @class */ (function () {
                ...
                if (base.formFields) {
                     ...
                     */function (field) {
                         ...
                         */function (f) { return f.name === field.name; })) < 0) {
                            baseFields.push(lodashEs.cloneDeep(field));
                        }
                    }));
                }
                model.formFields = lodashEs.compact(lodashEs.union(baseFields, formFields));
                model.searchableFields = lodashEs.uniq(lodashEs.union(lodashEs.cloneDeep(base.searchableFields), model.searchableFields));
                model.type = target;
                this.updateModel(className, model);
            };
        /**
         ...
         */
            function (className) {
                /** @type {?} */
                var retVal;
                if (lodashEs.isString(className) === true) {
         ...
         */
            function (collectionName, advancedFiltersFields, campaignFields, isAdmin) {
                ...
                if (model && model.formFields) {
                    fields = lodashEs.cloneDeep(model.formFields);
                }
                if (model && model.isCustom && fields) {
                     ...
                     */function (f) {
                        ...
                        f.sortable = f.type === stencil.FormFieldType.date || f.type === stencil.FormFieldType.datetime || f.type === stencil.FormFieldType.number;
                        if (f.type === stencil.FormFieldType.location) {
                ...
                if (advancedFiltersFields && advancedFiltersFields.length > 0) {
                     ...
                     */function (af) {
                        /** @type {?} */
                        var index = lodashEs.findIndex(fields, ( /**
                         * @param {?} f
                         * @return {?}
                ...
                /** @type {?} */
                var tenantIndex = lodashEs.findIndex(fields, ( /**
                 * @param {?} f
                 * @return {?}
                 ...
                 */function (f) {
                    ...
                    if (f.collectionName && f.collectionName !== collectionName && f.filterable === true && f.showSubQueryFilters === true) {
                         ...
                         * @return {?}
                         */function (subfield) {
                            subfield = lodashEs.cloneDeep(subfield);
         ...
         * @return {?}
         */
            function (field, translate$$1) {
                /** @type {?} */
                var fieldTitle = field.title || field.name;
                fieldTitle = translate$$1.polyglot(fieldTitle);
                return fieldTitle;
            };
        /**
         * @param {?} field
         ...
         */
            function (field) {
                return stencil.isBooleanField(field);
            };
        /**
         * @param {?} field
         * @return {?}
         ...
         */
            function (field) {
                return stencil.isNumberField(field);
            };
        /**
         * @param {?} field
         * @return {?}
         ...
         */
            function (field) {
                return stencil.isPhotoField(field);
            };
        /**
         * @param {?} field
         * @return {?}
         ...
         */
            function (field) {
                return stencil.isMultiPhotosField(field);
            };
        /**
         * @param {?} field
         * @return {?}
         ...
         */
            function (field) {
                return stencil.isPhotoOrMultiPhotosField(field);
            };
        /**
         * @param {?} field
         * @return {?}
         ...
         */
            function (field) {
                return stencil.isVideoField(field);
            };
        /**
         * @param {?} field
         * @return {?}
         ...
         */
            function (field) {
                return stencil.isDateTimeField(field);
            };
        /**
         * @param {?} field
         * @return {?}
         ...
         */
            function (field) {
                return stencil.isIntervalField(field);
            };
        /**
         * @param {?} field
         * @return {?}
         ...
         */
            function (field, includePhoto) {
                ...
                switch (field.type) {
                    case stencil.FormFieldType.checkbox:
                    case stencil.FormFieldType.toggle:
                    case stencil.FormFieldType.select:
                    case stencil.FormFieldType.selectmulti:
                    case stencil.FormFieldType.selectbuttons:
                    case stencil.FormFieldType.selectbuttonsmulti:
                    case stencil.FormFieldType.starrating:
                    case stencil.FormFieldType.number:
                    case stencil.FormFieldType.range:
                    case stencil.FormFieldType.ranking:
                    case stencil.FormFieldType.formula:
                        return true;
                    case stencil.FormFieldType.photo:
                    case stencil.FormFieldType.multiphotos:
                        return includePhoto;
                    case stencil.FormFieldType.autocomplete:
         ...
         */
            function (field) {
                return stencil.isMultipleField(field);
            };
        /**
         * @param {?} field
         * @return {?}
         ...
         */
            function (field) {
                return stencil.isColoredField(field);
            };
        /**
         * @param {?} field
         * @return {?}
         ...
         */
            function (field) {
                ...
                else if (field.type === stencil.FormFieldType.autocomplete || field.type === stencil.FormFieldType.location) {
        ...
        Models.getMobileFieldIcon =
            ...
            function (type) {
                /** @type {?} */
                var fields = [].concat(stencil.MOBILE_FORM_FIELDS_ALL).filter(( /**
                 * @param {?} field
                 * @return {?}
                 ...
                 */function (fs) {
                     ...
                     */function (f) {
                        if ((!f.subQuery || f.collectionName === collectionName) && (!excludedFields || excludedFields.indexOf(f.field) < 0)) {
                            ...
                            if (filter && !lodashEs.isEmpty(filter)) {
         ...
         */
            function (collectionName, filters, isAggregationQuery) {
                ...
                /** @type {?} */
                var retVal = [];
                if (filters && lodashEs.isArray(filters) && (( /** @type {?} */(filters))).length > 0) {
        ...
        Models.getPhotosFromParams =
            ...
            function (params) {
                if (params && params.node && params.node.data) {
                    ...
                    /** @type {?} */
                    var photos_1 = [];
                    if (row_1 && f_1 && row_1[f_1] && row_1[f_1].value && lodashEs.isArray(row_1[f_1].value)) {
                        row_1[f_1].value.forEach(( /**
                         * @param {?} v
                         * @param {?} multiIndex
                         * @return {?}
                         */function (v, multiIndex) {
                            photos_1.push(Models.extractPhoto(v, row_1, {}, f_1, stencil.FormFieldType.multiphotos, null, multiIndex));
                        }));
                    }
                    return photos_1;
                }
         ...
         */
            function (data, missiondata, field, name, type, hideUser, multiIndex) {
                ...
                if (data || (field && field.type === 'image' && field.image && field.image._downloadURL)) {
                    if (data && data.value && ((data.value.indexOf && data.value.indexOf('http') === 0) || stencil.isImageFile(data.value)) && (!type || !data.fieldType || data.fieldType === type)) {
                        photo = {
                            value: data.value,
                    ...
                    else if (data && ((data.indexOf && data.indexOf('http') === 0) || stencil.isImageFile(data))) {
                        if (type && type === stencil.FormFieldType.multiphotos) {
                            /** @type {?} */
                            var fieldData = lodashEs.get(missiondata, field.name || name);
                            /** @type {?} */
                    ...
                    if (!lodashEs.isEmpty(photo)) {
                        if (!field || field.type !== 'image') {
                            lodashEs.assign(photo, {
                                title: field.title,
                                name: field.name || name,
         ...
         */
            function (f) {
                /** @type {?} */
                var filter = {};
                if (lodashEs.isArray(f.value) && f.value.length === 0) {
                    return filter;
                }
                if (f.handleUndefined && stencil.isPresent(f.value) && lodashEs.isArray(f.value)) {
                    if (f.value.indexOf(undefined) < 0 && f.value.indexOf('undefined') < 0) {
                        ...
                        var def = filter;
                        def[f.field] = {};
                        def[f.field][f.operator._id] = lodashEs.map(f.value, ( /**
                         * @param {?} v
                         * @return {?}
                         */function (v) {
                    ...
                    filter[f.field] = {};
                    if (f.type === stencil.FormFieldType.address && f.value && (lodashEs.isArray(f.value) || lodashEs.isArray(f.value._geoloc))) {
                        filter[f.field] = {
                            nearSphere: {
                                $geometry: {
                                    type: 'Point',
                    ...
                    else if (f.operator._id === 'nearSphere' && f.value && (lodashEs.isArray(f.value) || lodashEs.isArray(f.value._geoloc))) {
                        filter[f.field] = {
                            nearSphere: {
                                $geometry: {
                                    type: 'Point',
                    ...
                    else if (f.type === stencil.FormFieldType.date && f.operator._id === 'eq') {
                        filter[f.field]['between'] = [f.value, stencil.dateFormat(stencil.dateAdd(f.value, 'days', 1), 'YYYY-MM-dd')];
                    }
                    else if (stencil.isPresent(f.value)) {
                        /** @type {?} */
                        var value = lodashEs.isArray(f.value) && lodashEs.isObject(f.value[0]) ? lodashEs.map(f.value, '_id') : lodashEs.isArray(f.value) ? f.value : lodashEs.isObject(f.value) ? f.value._id : f.value;
    ...
    var Smartloc = /** @class */ (function () {
                    ...
                    if (promise) {
                         ...
                         */function (loc) {
                            if (loc && loc._geoloc && loc._geoloc.length > 1) {
                                ...
                                /** @type {?} */
                                var position = new common.Position({ latitude: loc._geoloc[1], longitude: loc._geoloc[0] });
                                return position;
                            }
                            return null;
                        }));
        ...
        /** @nocollapse */
        Smartloc.ctorParameters = function () {
            return [
                { type: Session },
                { type: common.GeoLocation },
                { type: Config },
                { type: Requestor }
            ];
        };
    ...
    function normalizeObservable(o) {
        return o instanceof rxjs.Observable ? o : rxjs.from(Promise.resolve(o));
    }
    var Googlemaps = /** @class */ (function () {
         ...
         */
            function (input, offset, location, radius, language, types, components, query) {
                ...
                if (location === void 0) {
                    location = rxjs.from(this.geo.getLocation().then(( /**
                     * @param {?} pos
                     * @return {?}
                ...
                return normalizeObservable(location).pipe(operators.map(( /**
                 * @param {?} loc
                 * @return {?}
                 */function (loc) {
                    return {
         ...
         */
            function (inputO, offsetO, locationO, radius, language, types, components, query) {
                var _this = this;
                if (offsetO === void 0) {
                    offsetO = inputO.pipe(operators.map(( /**
                     * @param {?} s
                     * @return {?}
                     */function (s) { return s.length; })));
                }
                if (locationO === void 0) {
                    locationO = rxjs.from(this.geo.getLocation().then(( /**
                     * @param {?} pos
                     * @return {?}
                     */function (pos) { return pos.toStringLoc(); })));
                }
                ...
                return rxjs.combineLatest(inputO, offsetO, locationO).pipe(operators.concatMap(( /**
                 * @param {?} i
                 * @return {?}
                 */function (i) { return _this._autocomplete(i, query); })));
            };
         ...
         */
            function (locationO, keywordO, radius, language, nameO, minprice, maxprice, opennow, rankby, type, types) {
                ...
                return rxjs.combineLatest(keywordO, nameO, locationO).pipe(operators.concatMap(( /**
                 * @param {?} i
                 * @return {?}
         ...
         */
            function (address, components, bounds, language, region) {
                ...
                return address.pipe(operators.map(( /**
                 * @param {?} addr
                 * @return {?}
                 */function (addr) {
                    return {
         ...
         */
            function (latlng, language, result_type, location_type) {
                var _this = this;
                if (latlng === void 0) {
                    latlng = rxjs.from(this.geo.getLocation().then(( /**
                     * @param {?} pos
                     * @return {?}
                     */function (pos) { return pos.toStringLoc(); })));
                }
                ...
                return normalizeObservable(latlng).pipe(operators.map(( /**
                 * @param {?} loc
                 * @return {?}
                 */function (loc) {
                    return {
         ...
         */
            function (place_idO, language, result_type, location_type) {
                ...
                return place_idO.pipe(operators.map(( /**
                 * @param {?} place_id
                 * @return {?}
                 */function (place_id) {
                    return {
                 ...
                 * @param {?} i
                 * @return {?}
                 */function (i) { return _this._reverseGeocode(i); })), operators.map(( /**
                 * @param {?} results
                 * @return {?}
                 */function (results) { return results[0]; })));
            };
            ...
            function (forceRefresh) {
                 ...
                 */function (res) {
                        ...
                        if (res && res.length > 0) {
                             ...
                             */function (d) {
                                /** @type {?} */
                                var position = new common.Position(d.geometry.location);
                                return {
         ...
         */
            function (input, query) {
                return this.rq.post(this.apiUrl + "place/autocomplete?query=" + query, input).pipe(operators.map(( /**
                 * @param {?} res
                 * @return {?}
                 */function (res) {
         ...
         */
            function (input) {
                return this.rq.post(this.apiUrl + 'geocode', input).pipe(operators.map(( /**
                 * @param {?} res
                 * @return {?}
                 */function (res) {
                    return res.results;
         ...
         */
            function (input) {
                return this.rq.post(this.apiUrl + 'reverse-geocode', input).pipe(operators.map(( /**
                 * @param {?} res
                 * @return {?}
                 */function (res) {
                    if (lodashEs.isString(res)) {
                        res = JSON.parse(res);
                    }
                    return lodashEs.uniqBy(res.results, ( /**
                     * @param {?} t
                     * @return {?}
        ...
        /** @nocollapse */
        Googlemaps.ctorParameters = function () {
            return [
                { type: Requestor },
                { type: Smartloc },
                { type: Config },
    ...
    var Workplace = /** @class */ (function () {
        ...
        /** @nocollapse */
        Workplace.ctorParameters = function () {
            return [
                { type: Requestor },
                { type: Config }
            ];
    ...
    var Files = /** @class */ (function () {
         ...
         */
            function (file) {
                return stencil.isImageFile(file);
            };
        /**
         * @param {?} nativeFile
         * @param {?=} type
         ...
         */
            function (nativeFile, type, encoding) {
                ...
                return stencil.read(( /** @type {?} */(nativeFile)), type, encoding);
            };
        /**
         * @param {?} file
         * @return {?}
         ...
         */
            function (file) {
                return stencil.getExtension(file);
            };
        /**
         * @param {?} filename
         * @param {?} extension
         ...
         */
            function (filename, extension) {
                return stencil.changeExtension(filename, extension);
            };
        /**
         * @param {?} extension
         * @return {?}
         ...
         */
            function (extension) {
                return stencil.getMaxSize(extension);
            };
        /**
         * @param {?} value
         * @return {?}
         ...
         */
            function (file) {
                return stencil.isValid(( /** @type {?} */(file)));
            };
        /**
         * @param {?} file
         * @return {?}
         ...
         */
            function (file) {
                return stencil.isDocument(file);
            };
        /**
         * @param {?} file
         * @return {?}
         ...
         */
            function (file) {
                return stencil.getMimeType(file);
            };
        /**
         * @param {?} file
         * @return {?}
         ...
         */
            function (value) {
                return stencil.getVideoPoster(value);
            };
        /**
         * @param {?} b64Data
         * @param {?=} contentType
         ...
         */
            function (b64Data, contentType, sliceSize) {
                ...
                return stencil.b64toBlob(b64Data, contentType, sliceSize);
            };
        /**
         * @param {?} blob
         * @return {?}
         ...
         */
            function (blob) {
                return stencil.blobToFile(blob);
            };
        /**
         * @param {?} data
         * @param {?} file
         ...
         */
            function (data, file) {
                return stencil.b64ToFile(data, ( /** @type {?} */(file)));
            };
        /**
         * @param {?} data
         * @return {?}
         ...
         */
            function (data) {
                return stencil.saveBase64AsImageFile(data);
            };
        /**
         * @param {?} base64
         * @param {?} maxWidth
         ...
         */
            function (base64, maxWidth, maxHeight) {
                return stencil.resizeBase64Image(base64, maxWidth, maxHeight);
            };
        /**
         * @param {?} base64
         * @return {?}
         ...
         */
            function (base64) {
                return stencil.getBase64MimeType(base64);
            };
        /**
         * @param {?} base64
         * @return {?}
         ...
         */
            function (base64) {
                return stencil.getBase64Extension(base64);
            };
        /**
         * @param {?} file
         * @param {?} maxWidth
         ...
         */
            function (file, maxWidth, maxHeight) {
                return stencil.resizeImage(( /** @type {?} */(file)), maxWidth, maxHeight);
            };
        /**
         * @param {?} subfolder
         * @return {?}
         ...
         */
            function (subfolder) {
                return stencil.getNativeDirectory(subfolder);
            };
        /**
         * @param {?} filePath
         * @return {?}
         ...
         */
            function (filePath) {
                return stencil.resolveFilePath(filePath);
            };
        /**
         * @param {?} path
         * @param {?} fileName
         ...
         */
            function (path, fileName) {
                return stencil.fixImageOrientation(path, fileName);
            };
        ...
        Files.prototype.moveToImageDirectory =
            ...
            function (originalFilePath, disableOrientationFix) {
                if (disableOrientationFix === void 0) {
                    disableOrientationFix = false;
                }
                return stencil.moveToImageDirectory(originalFilePath, disableOrientationFix);
            };
        /**
         * @param {?} fileDirPath
         * @param {?} fileEntry
         ...
         */
            function (fileDirPath, fileEntry, newName, originalFilePath) {
                return stencil.moveToImageDirectoryBase(fileDirPath, fileEntry, newName, originalFilePath);
            };
        /**
         * @param {?} path
         * @param {?} fileName
         ...
         */
            function (path, fileName, text, options) {
                return stencil.fileNativeWriteFile(path, fileName, text, options);
            };
        /**
         * @param {?} path
         * @param {?} fileName
         ...
         */
            function (path, fileName) {
                return stencil.fileNativeCheckFile(path, fileName);
            };
        /**
         * @param {?} data
         * @return {?}
         ...
         */
            function (data) {
                return stencil.fixAbsolutePath(data);
            };
        /**
         * @param {?} retVal
         * @return {?}
         ...
         */
            function (retVal) {
                return stencil.getCloudinaryUrl(retVal);
            };
        /**
         * @param {?} filename
         * @param {?} mediaType
         ...
         */
            function () {
                return stencil.getLocalFilePath();
            };
        /**
         * @param {?} fileName
         * @return {?}
         ...
         */
            function (fileName) {
                return stencil.getLocalFileName(fileName);
            };
        /**
         * @param {?} blob
         * @param {?} fileName
         ...
         */
            function (blob, fileName) {
                return stencil.saveToLocalFile(blob, fileName);
            };
        /**
         * @param {?} src
         * @param {?=} photo
         ...
         */
            function (src, photo) {
                return stencil.getUrlWithAnnotations(src, photo);
            };
        /**
         * @param {?} fileName
         * @return {?}
         ...
         */
            function (fileName) {
                return stencil.cleanFileName(fileName);
            };
        /**
         * @param {?} source
         * @param {?} target
         ...
         */
            function (source, target) {
                return stencil.downloadFileToDevice(source, target);
            };
        /**
         * @param {?} filePath
         * @param {?=} fileName
         ...
         */
            function (filePath, fileName) {
                ...
                return stencil.showPdfOnDevice(filePath, fileName);
            };
        /**
         * @param {?} photoUrl
         * @return {?}
         ...
         */
            function (photoUrl) {
                ...
                return this.rq.post(url, { url: photoUrl }).pipe(operators.map(( /**
                 * @param {?} retVal
                 * @return {?}
                 */function (retVal) {
         ...
         */
            function (blob, fileName, mimeType) {
                return stencil.openBlob(blob, fileName, mimeType);
            };
        /**
         * @param {?} filePath
         * @param {?} mimeType
         ...
         */
            function (filePath, mimeType) {
                return stencil.afterOpenBlob(filePath, mimeType);
            };
        /**
         * @return {?}
         */
    ...
    var Box = /** @class */ (function () {
         ...
         */
            function (documentUrl) {
                ...
                return this.rq.post(url, { params: { documentUrl: documentUrl } }).pipe(operators.map(( /**
                 * @param {?} retVal
                 * @return {?}
                 */function (retVal) {
         ...
         */
            function (boxId) {
                ...
                return this.rq.post(url, { params: { boxId: boxId } }).pipe(operators.map(( /**
                 * @param {?} retVal
                 * @return {?}
                 */function (retVal) {
                    if (retVal && retVal.data) {
         ...
         */
            function (contentUrl) {
                ...
                return this.rq.post(url, { params: { contentUrl: contentUrl } }).pipe(operators.map(( /**
                 * @param {?} retVal
                 * @return {?}
                 */function (retVal) {
                    if (retVal && retVal.data) {
    ...
    var Unsplash = /** @class */ (function () {
         ...
         */
            function (search, skip, limit) {
                ...
                return this.rq.get(url, null, null, null, true).pipe(operators.map(( /**
                 * @param {?} ret
                 * @return {?}
                 */function (ret) {
                    //{
        ...
        /** @nocollapse */
        Unsplash.ctorParameters = function () {
            return [
                { type: Requestor },
                { type: common.CoreConfig }
            ];
    ...
    var Broker = /** @class */ (function () {
        function Broker(rq, box, googlemaps, workplace, session, files, promise, coreConfig, log, network, transfer, localForage, config, injector, cache, geoloc, translate$$1, unsplash) {
            this.rq = rq;
            this.box = box;
         ...
         */
            function (collectionName, id, fields, include, idAttributeName) {
                ...
                if (this.network.isOffline()) {
                    return rxjs.from(this.cache.getByIdFromDatabaseCollection(collectionName, id, idAttributeName));
                }
                    ...
                    return this.getAll(collectionName, fields, include, null, filters).pipe(operators.map(( /**
                     * @param {?} res
                     * @return {?}
                     */function (res) {
         ...
         */
            function (collectionName, entity) {
                ...
                if (this.network.isOffline()) {
                    return rxjs.from(this.cache.upsertInDatabaseCollection(collectionName, entity));
                }
                else {
         ...
         */
            function (collectionName, entity, fields) {
                ...
                if (this.network.isOffline() || this.isOfflineEntity(entity)) {
                    ...
                    return this.upsert(collectionName, entity).pipe(operators.mergeMap(( /**
                     * @param {?} res
                     * @return {?}
         ...
         */
            function (collectionName, entity) {
                ...
                this.updateCustomModel(collectionName, entity);
                if (this.network.isOffline() || this.isOfflineEntity(entity)) {
                    return rxjs.from(this.cache.upsertInDatabaseCollection(collectionName, entity, true));
                }
                else {
                    /** @type {?} */
         ...
         */
            function (entity, suffixs, progressEmitter, tags, promisesOnly, totalOffset) {
                ...
                if (promisesOnly === void 0) {
                    promisesOnly = false;
                }
                if (totalOffset === void 0) {
                    totalOffset = 0;
                }
                /** @type {?} */
                 ...
                 */function (prop) {
                    ...
                    var promise;
                    /** @type {?} */
                    var file = lodashEs.get(entity, prop);
                    promise = (( /**
                     * @param {?} offsetIndex
                     * @param {?} total
                     * @return {?}
         ...
         */
            function (collectionName, query, entity) {
                /** @type {?} */
                var rawQuery = lodashEs.assign({}, query.where);
                if (query.subQuery) {
         ...
         */
            function (entity, group, addWrite, collectionName, users) {
                ...
                if (group) {
                    entity._acl.groups.r = lodashEs.uniq([].concat(group).concat(entity._acl.groups.r));
                }
                entity._acl.groups.r = lodashEs.compact(entity._acl.groups.r);
                //entity._acl.groups.w = compact(uniq(['admin', 'manager'].concat(entity._acl.groups.w || [])));
                entity._acl.groups.w = lodashEs.compact(lodashEs.uniq([].concat(entity._acl.groups.w || [])));
                if (collectionName === 'translations' && group) {
                    entity._acl.groups.r = lodashEs.uniq([].concat(group));
                    entity._acl.groups.w = lodashEs.uniq([].concat(group));
                }
                if (addWrite && group) {
                    entity._acl.groups.w = lodashEs.compact(lodashEs.uniq([].concat(group).concat(entity._acl.groups.w)));
                }
         ...
         */
            function (file, progressEmitter, offsetIndex, total, tags, totalOffset) {
                ...
                tags = lodashEs.concat([this.session.userId], tags);
         ...
         */
            function (collectionName, entity) {
                if (entity.tags && entity.tags.length > 0) {
                    entity.tags = lodashEs.uniq(lodashEs.compact([].concat(entity.tags)));
         ...
         */
            function (collectionName, id) {
                if (this.isOfflineId(id)) {
                    return rxjs.from(this.cache.removeFromDatabaseCollection(collectionName, id));
                }
                else {
                    /** @type {?} */
         ...
         */
            function (collectionName, query) {
                ...
                var url = this.config.apiUrl + this.getCollectionName(collectionName);
                /** @type {?} */
                var rawQuery = lodashEs.assign({}, query.where || { _id: { exists: true } });
                if (query.subQuery) {
                    rawQuery.__options = { subQuery: query.subQuery };
                }
         ...
         */
            function (collectionName, fields, include, search, filters, sorts, skip, limit, subQuery, customFilter) {
                ...
                if (model) {
                    ...
                    if (model && model.isCustom) {
                        if (!filters || (lodashEs.isArray(filters) && (( /** @type {?} */(filters))).length < 1)) {
                            filters = [[]];
                        }
                        if (lodashEs.isArray(filters)) {
                            filters = lodashEs.cloneDeep(filters);
                            (( /** @type {?} */(filters))).forEach(( /**
                             * @param {?} f
                             * @return {?}
                             */function (f) {
                ...
                if (sorts && sorts.length > 0) {
                     ...
                     * @param {?} s
                     * @return {?}
                     */function (s) { return lodashEs.isString(s) || (s.colId && s.sort); })).map(( /**
                     * @param {?} s
                     * @return {?}
                     */function (s) { return (lodashEs.isString(s) ? s : s.colId + ' ' + (s.sort ? s.sort.toUpperCase() : 'ASC')); }));
                }
                ...
                else if (filters && !lodashEs.isArray(filters) && lodashEs.isObject(filters)) {
                    filterWhere = filters;
                }
                ...
                if (search && model && model.searchSubquery) {
                    ...
                    else if (query.subQuery && !lodashEs.isArray(query.subQuery) && (( /** @type {?} */(query.subQuery))).where) {
         ...
         */
            function (collectionName, search, filters, subQuery, customFilter, noOffline) {
                ...
                if (this.network.isOffline()) {
                    return this.getAllOffline(collectionName, false, search, filters, null, null, null, customFilter, false).pipe(operators.map(( /**
                     * @param {?} ret
                     * @return {?}
                     */function (ret) {
                 ...
                 */function (res) {
                        ...
                        if (noOffline) {
                            ...
                            return rxjs.from(_this.getAllOffline(collectionName, true, search, filters, null, null, null, customFilter));
                        }
                    })))
                        .pipe(operators.map(( /**
                 * @param {?} offlineRes
         ...
         */
            function (collectionName, fields, include, search, filters, sorts, skip, limit, tag, subQuery, customFilter, cacheId, looseCount, noCount, noOffline) {
                ...
                if (tag === true) {
                    ...
                    if (this.network.isOffline()) {
                        if (cacheId) {
                            obs = rxjs.from(this.localForage.get(cacheId)).pipe(operators.map(( /**
                             * @param {?} res
                             * @return {?}
                             */function (res) {
                     ...
                     */function (res) {
                            ...
                            if (noOffline) {
                                ...
                                return rxjs.from(_this.getAllOffline(collectionName, true, search, filters, sorts, skip, limit, customFilter, noCount));
                            }
                        })))
                            .pipe(operators.map(( /**
                     * @param {?} offlineRes
         ...
         */
            function (collectionName, search, filters, skip, limit, useTagsCollection) {
                ...
                if (this.network.isOffline()) {
                    ...
                    return this.aggregateQuery('tags', filters, aggregateOptions, search).pipe(operators.map(( /**
                     * @param {?} res
                     * @return {?}
                    ...
                    return this.aggregateQuery(collectionName, filters, aggregateOptions).pipe(operators.map(( /**
                     * @param {?=} res
                     * @return {?}
                     */function (res) {
                        if (res === void 0) {
         ...
         */
            function (config) {
                return this.getAllOffline(config.collectionName, false, config.search, config.filters, null, null, null, null, true).pipe(operators.map(( /**
                 * @param {?} res
                 * @return {?}
                 */function (res) {
                    /** @type {?} */
                    ...
                    if (res && res.length > 0) {
                        ...
                        lodashEs.keys(count).forEach(( /**
                         * @param {?} key
                         * @return {?}
                         */function (key) {
                            data.push({ _id: key, tag: key, count: count[key] });
                        }));
                        data = lodashEs.orderBy(data, ( /**
                         * @param {?} d
                         * @return {?}
         ...
         */
            function (config, skip, limit) {
                ...
                if (this.network.isOffline()) {
                    ...
                    return this.aggregateQueries(queries).pipe(operators.map(( /**
                     * @param {?} rets
                     * @return {?}
                     */function (rets) {
                        /** @type {?} */
         ...
         */
            function (search) {
                if (search) {
                    return this.googlemaps.placePredictionsLocationObserver(search).pipe(operators.map(( /**
                     * @param {?} predictions
                     * @return {?}
                     */function (predictions) {
                        /** @type {?} */
                        var details = lodashEs.flatten(predictions).filter(( /**
                         * @param {?} d
                         * @return {?}
                    ...
                    return rxjs.from(this.googlemaps.getCurrentAddresses(true)).pipe(operators.map(( /**
                     * @param {?} addresses
                     * @return {?}
                     */function (addresses) {
                ...
                if (collections && collections.length > 0) {
                     ...
                     */function (entry, i) {
                         ...
                         */function () {
                             ...
                             */function (data) {
                                /** @type {?} */
                                var filters = lodashEs.cloneDeep(entry.filters || [[]]);
                                filters.forEach(( /**
                                 * @param {?} fs
                                 * @return {?}
                                 */function (fs) {
                                     ...
                                     * @return {?}
                                     */function (f) {
                                        if (f.value && lodashEs.isArray(f.value) && f.value.indexOf('currentLanguage') >= 0) {
                                             ...
                                             */function (key) {
                                                 ...
                                                 */function (item) {
                                                    if (item[key]) {
                                                        filePromises_1.push(( /**
                                                         * @return {?}
                                                         */function () { return stencil.cacheFile(item[key]); }));
                                                    }
                                                }));
                                            }));
                                        }
         ...
         */
            function (collectionName, data) {
                ...
                return this.rq.post(url, { modelName: modelName, ids: data.map(( /**
                         * @param {?} e
                         * @return {?}
                         */function (e) { return e._id; })) }).pipe(operators.map(( /**
             * @param {?} retVal
             * @return {?}
             */function (retVal) {
                    if (retVal) {
                ...
                if (!this.isUploadingDatabase || this.network.isOffline()) {
                     ...
                     */function (custommodels) {
                        if (collections_1 && collections_1.length > 0) {
                            collections_1 = lodashEs.cloneDeep(collections_1);
         ...
         */
            function (collectionName, offlineOnly, search, filters, sorts, skip, limit, customFilter, noCount) {
                ...
                return rxjs.from(this.cache.getDatabaseCollection(collectionName).then(( /**
                 * @param {?} data
                 * @return {?}
                 */function (data) {
                    /** @type {?} */
                    ...
                    if (filters && filters.length > 0) {
                                 ...
                                 */function (e) {
                                    ...
                                    if (e && e[f.field] !== undefined && e[f.field] !== null) {
                                        switch (f.operator._id) {
                                            case 'eq':
                                                return lodashEs.isEqual(e[f.field], value);
                                            case 'neq':
                                                return !lodashEs.isEqual(e[f.field], value);
                                            case 'inq':
                                                return lodashEs.intersection([].concat(e[f.field]), [].concat(value)).length > 0;
                                            case 'nin':
                                                return lodashEs.intersection([].concat(e[f.field]), [].concat(value)).length <= 0;
                                            case 'gt':
                                            ...
                                            case 'nearSphere':
                                                ...
                                                break;
                                            case 'exists':
                                                return !stencil.isNullOrUndefined(e[f.field]);
                                                break;
                                        }
                                    }
                                    else {
                        ...
                        data = lodashEs.uniqBy(newData_1, ( /**
                         * @param {?} e
                         * @return {?}
                     ...
                     */function (fs) {
                        ...
                        data = lodashEs.orderBy(data, ['distance']);
                    }
                    if (sorts) {
                        data = lodashEs.orderBy(data, sorts.map(( /**
                         * @param {?} s
                         * @return {?}
         ...
         */
            function (collectionName, filters, aggregateOptions, search, excludedFields, includeCount, cacheId, customFilter, subQuery, aggregateOptionsOffline) {
                ...
                if (this.network.isOffline()) {
                    if (cacheId) {
                        obs = rxjs.from(this.localForage.get(cacheId));
                    }
                    else if (aggregateOptionsOffline) {
                        obs = rxjs.from(this.cache.getDatabaseCollection(collectionName).then(( /**
                         * @param {?} data
                         * @return {?}
                         */function (data) {
                    ...
                    obs = this.rq.post(url, { params: query }).pipe(operators.map(( /**
                     * @param {?} retVal
                     * @return {?}
                     */function (retVal) {
                        if (cacheId) {
         ...
         */
            function (queries, includeCount, cacheId) {
                ...
                if (this.network.isOffline()) {
                    ...
                    obs = this.rq.post(url, queries).pipe(operators.map(( /**
                     * @param {?} retVal
                     * @return {?}
                     */function (retVal) {
                        /** @type {?} */
                         ...
                         * @param {?} d
                         * @return {?}
                         */function (d) { return lodashEs.isObject(d.doc); }))) {
                            retVal.data.forEach(( /**
                             * @param {?} d
                             * @return {?}
                             */function (d) {
                        ...
                        else if (retVal && lodashEs.isArray(retVal.data) && retVal.data.length === 0) {
                            retVal.data = finalArray;
                        }
                        if (cacheId) {
                            _this.localForage.set(cacheId, retVal);
         ...
         */
            function (collectionName, filters, aggregateOptions, search, excludedFields, includeCount, customFilter, subQuery) {
                ...
                if (!lodashEs.isEmpty(project)) {
                    aggregateOptions.unshift({ $project: project });
                }
                if (!lodashEs.isEmpty(match)) {
         ...
         */
            function (fileTypes, maxFileSize) {
                ...
                // }
                return new ng2FileUpload.FileUploader(options);
            };
        /**
         * @param {?} params
         * @return {?}
         ...
         */
            function (id, mode, customFilter) {
                /** @type {?} */
                var value = ( /** @type {?} */((lodashEs.isString(id) ? [{ _id: id }] : id)));
                /** @type {?} */
                ...
                return this.aggregateQuery('missions', filters, options, null, null, false, null, customFilter).pipe(operators.map(( /**
                 * @param {?} stats
                 * @return {?}
                 */function (stats) {
         ...
         */
            function (entity, suffixs) {
                ...
                var _loop_1 = function (prop) {
                    ...
                    lodashEs.forEach(suffixs, ( /**
                     * @param {?} suffix
                     * @return {?}
                     */function (suffix) {
                        if (suffix) {
                            /** @type {?} */
                            var object = lodashEs.get(entity, prop + suffix);
                            if (lodashEs.isArray(object)) {
                                // for multiphoto field, value is an array;
                                /** @type {?} */
                                var extraDataSuffix = '.extraData';
                                /** @type {?} */
                                var extraData_1 = lodashEs.get(entity, prop + extraDataSuffix);
                                object.forEach(( /**
                                 * @param {?} v
                                 * @param {?} index
                                 * @return {?}
                                ...
                                if (_this.files.isImageFile(lodashEs.get(entity, prop + suffix))) {
                                    retVal = true;
                                }
                            }
                        }
                        ...
                        if (suffix) {
                            ...
                            if (lodashEs.isArray(objectPath_1)) {
                                 ...
                                 */function (extraDataSuffix) {
                                    /** @type {?} */
                                    var extraData = lodashEs.get(entity, prop + extraDataSuffix);
        ...
        /** @nocollapse */
        Broker.ctorParameters = function () {
            return [
                { type: Requestor },
                { type: Box },
                { type: Googlemaps },
    ...
    function getStartAndEndDates(timescale, endDate, amount, notsliding, previous) {
        ...
        /** @type {?} */
        var dateFrom = stencil.startOf(stencil.dateAdd(stencil.utc(stencil.toDate(lastDate)), period, -amount), startof);
        /** @type {?} */
        var dateTo = stencil.toDate(lastDate);
        if (previous) {
            dateFrom = stencil.dateAdd(dateFrom, period, -amount);
            dateTo = stencil.dateAdd(dateTo, period, -amount);
        }
    ...
    function isNotInformationField(m) {
        return m.type !== stencil.FormFieldType.information;
    }
    /**
     * @return {?}
     */
    function getFormFieldValues() {
        return lodashEs.map(stencil.MOBILE_FORM_FIELDS_ALL.filter(isNotInformationField), 'type');
    }
    var Condition = /** @class */ (function (_super) {
        ...
        __decorate([
            Editable('Condition', { type: stencil.FormFieldType.text, required: true }),
        ...
        __decorate([
            Editable('Condition', {
                ...
                defaultType: stencil.FormFieldType.text,
                required: true,
    ...
    var ConditionalField = /** @class */ (function (_super) {
        ...
        __decorate([
            Editable('ConditionalField', { type: stencil.FormFieldType.text, readonly: true, title: 'FIELDIF' }),
            __metadata("design:type", String)
        ...
        __decorate([
            Editable('ConditionalField', { type: stencil.FormFieldType.text, required: true, title: 'TITLE' }),
            __metadata("design:type", String)
        ], ConditionalField.prototype, "newfieldTitle", void 0);
        __decorate([
            Editable('ConditionalField', { title: 'INSTRUCTIONS', type: stencil.FormFieldType.textarea }),
            __metadata("design:type", String)
        ], ConditionalField.prototype, "newfieldDescription", void 0);
        __decorate([
            Editable('ConditionalField', { title: 'MANDATORY', type: stencil.FormFieldType.checkbox }),
            __metadata("design:type", Boolean)
    ...
    var Tenant = /** @class */ (function (_super) {
        ...
        __decorate([
            Editable('Tenant', { required: true, type: stencil.FormFieldType.text }),
            Searchable('Tenant'),
            __metadata("design:type", String)
        ], Tenant.prototype, "name", void 0);
        __decorate([
            Editable('Tenant', { required: false, type: stencil.FormFieldType.text }),
            Searchable('Tenant'),
            __metadata("design:type", String)
        ], Tenant.prototype, "title", void 0);
        __decorate([
            Editable('Tenant', { required: false, type: stencil.FormFieldType.textarea }),
            Searchable('Tenant'),
            __metadata("design:type", String)
        ...
        __decorate([
            Editable('Tenant', { type: stencil.FormFieldType.toggle }),
            __metadata("design:type", Boolean)
    ...
    var LocationType = /** @class */ (function (_super) {
        ...
        __decorate([
            Editable('LocationType', { type: stencil.FormFieldType.text, required: true, exportOrder: 2 }),
    ...
    var Location = /** @class */ (function () {
        ...
        __decorate([
            ...
            Editable('Location', {
                required: true,
                type: stencil.FormFieldType.address,
                filterName: '_geoloc',
        ...
        __decorate([
            ...
            Editable('Location', {
                type: stencil.FormFieldType.photo,
                filterable: false,
                title: 'PHOTO',
        ...
        __decorate([
            ...
            Editable('Location', {
                ...
                type: stencil.FormFieldType.emailreport,
                showUsers: true,
                stateful: false,
                tab: 'INFORMATION',
                exportOrder: 11,
        ...
        __decorate([
            ...
            Editable('Location', {
                type: stencil.FormFieldType.email,
                tab: 'INFORMATION',
                exportOrder: 7,
                filterableAdvanced: true
            }),
    ...
    var User = /** @class */ (function (_super) {
            ...
            function (user) {
                if (user) {
                    ...
                    if (user.firstName && user.lastName) {
                        displayName = lodashEs.startCase(user.firstName.toString().toLowerCase()) + ' ' + lodashEs.startCase(user.lastName.toString().toLowerCase());
                    }
                    else if (user.first_name && user.last_name) {
                        displayName = lodashEs.startCase(user.first_name.toString().toLowerCase()) + ' ' + lodashEs.startCase(user.last_name.toString().toLowerCase());
                    }
        ...
        __decorate([
            Editable('User', {
                required: true,
                type: stencil.FormFieldType.password,
                secondary: true,
                icon: 'yo-password',
                disableAutocomplete: true,
        ...
        __decorate([
            Editable('User', {
                flex: 50,
                type: stencil.FormFieldType.tel,
                exportOrder: 7,
                filterableAdvanced: true,
                advanced: true
            }),
        ...
        __decorate([
            Editable('User', { type: stencil.FormFieldType.address, exportOrder: 9, advanced: true }),
            __metadata("design:type", Object)
    ...
    var SimpleUser = /** @class */ (function (_super) {
        ...
        __decorate([
            Editable('SimpleUser', { type: stencil.FormFieldType.text, visible: false }),
            __metadata("design:type", String)
        ...
        __decorate([
            Editable('SimpleUser', { required: true, type: stencil.FormFieldType.email }),
            Searchable('SimpleUser'),
            __metadata("design:type", String)
        ], SimpleUser.prototype, "username", void 0);
        __decorate([
            Editable('SimpleUser', { visible: true, required: true, type: stencil.FormFieldType.email }),
            Searchable('SimpleUser'),
            __metadata("design:type", String)
    ...
    var Notification = /** @class */ (function (_super) {
        ...
        __decorate([
            Editable('Notification', { type: stencil.FormFieldType.text, required: true }),
            Searchable('Notification'),
            __metadata("design:type", String)
        ], Notification.prototype, "title", void 0);
        __decorate([
            Editable('Notification', { type: stencil.FormFieldType.textarea, required: true }),
            __metadata("design:type", String)
        ], Notification.prototype, "body", void 0);
        __decorate([
            Editable('Notification', {
                type: stencil.FormFieldType.datetime,
                minDate: new Date(),
                condition: 'mode!="sms"'
            }),
    ...
    var Push = /** @class */ (function () {
        function Push(coreConfig, log, config, rq, oneSignal, pushNative) {
            ...
            this._notificationReceived = new rxjs.Subject();
            this.registered = false;
            this._oneSignalPlayerIdChange = new rxjs.Subject();
        }
         ...
         */
            function (user) {
                ...
                this._parentSubscription = new rxjs.Subscription();
                if (this.coreConfig.isCordova()) {
                     ...
                     */function (retVal) {
                        ...
                        _this.oneSignal.sendTags(lodashEs.pick(user, _this.tags));
                     ...
                     */function (resolve, reject) {
                         ...
                         * @return {?}
                         */function () {
                            window.OneSignal.sendTags(lodashEs.pick(user, _this.tags));
         ...
         */
            function (user, oneSignalId) {
                if (user) {
                    user.oneSignalId = lodashEs.uniq(lodashEs.compact(lodashEs.union([].concat(user.oneSignalId), [oneSignalId])));
                    user.oneSignalAppIds = user.oneSignalAppIds || {};
                    /** @type {?} */
                    var bundleId = this.coreConfig.getAppId().replace(/\./g, '_');
                    user.oneSignalAppIds[bundleId] = lodashEs.uniq(lodashEs.compact(lodashEs.union([].concat(user.oneSignalAppIds[bundleId]), [oneSignalId])));
                }
            };
        /**
         * @param {?} notif
         ...
         */
            function (user) {
                if (this.coreConfig.isCordova()) {
                    ...
                    user.oneSignalId = lodashEs.without(user.oneSignalId, this.currentOneSignalId);
                    user.oneSignalAppIds = user.oneSignalAppIds || {};
                    /** @type {?} */
                    var bundleId = this.coreConfig.getAppId().replace(/\./g, '_');
                    user.oneSignalAppIds[bundleId] = lodashEs.without(user.oneSignalAppIds[bundleId], this.currentOneSignalId);
                    this.registered = false;
                }
            };
        /**
         ...
         */
            function (user, token) {
                ...
                if (!user._messaging || !lodashEs.isArray(user._messaging.pushTokens)) {
                    user._messaging = { pushTokens: [] };
                }
                user._messaging.pushTokens.push({ token: token, platform: platform });
                user._messaging.pushTokens = lodashEs.uniqBy(user._messaging.pushTokens, ( /**
                 * @param {?} push
                 * @return {?}
         ...
         */
            function (user, token) {
                if (user._messaging && lodashEs.isArray(user._messaging.pushTokens)) {
                    user._messaging.pushTokens = lodashEs.filter(user._messaging.pushTokens, ( /**
                     * @param {?} push
                     * @return {?}
         ...
         */
            function (user, platform) {
                ...
                if (user._messaging && user._messaging.pushTokens) {
                    tokens = lodashEs.union(lodashEs.map(lodashEs.filter(user._messaging.pushTokens, ( /**
                     * @param {?} push
                     * @return {?}
         ...
         */
            function (userQuery, notification) {
                if (!lodashEs.isEmpty(userQuery) && (!lodashEs.isEmpty(userQuery.where) || !lodashEs.isEmpty(userQuery.subQuery.where))) {
                    //notification.userQuery = { where: { _id: { inq: userIds } } };
                    notification.userQuery = userQuery;
                    notification._tenantRef = notification._tenantRef || lodashEs.get(userQuery, ['where', '_tenantRef']) || lodashEs.get(userQuery, ['subQuery', 'where', '_tenantRef']);
                    return this.notify(notification);
                }
                else {
                    return rxjs.of(null);
         ...
         */
            function (notification, noQuery, userIds) {
                ...
                if (notification.scheduledDate) {
                    notification.scheduledDate = stencil.toDate(notification.scheduledDate);
                }
                ...
                notification.notificationOptions = lodashEs.merge(notification.notificationOptions || {}, {
                     ...
                     */function (resolve, reject) {
                        ...
                        _this.push = _this.pushNative.init({
                            android: {
                                ...
                                iconColor: common.Colors.success,
                                icon: 'notify'
                            },
        ...
        /** @nocollapse */
        Push.ctorParameters = function () {
            return [
                { type: common.CoreConfig },
                { type: common.Log },
                { type: Config },
                { type: Requestor },
                { type: ngx$5.OneSignal },
                { type: ngx$6.Push }
            ];
        };
        return Push;
    ...
    var Authentication = /** @class */ (function () {
        function Authentication(rq, push, config, broker, network, localStorage, localForage, session, coreConfig) {
            ...
            this.profileUpdated$ = new core.EventEmitter();
        }
        /**
         * @param {?} username
         * @param {?} password
         ...
         */
            function (username, password, roles) {
                ...
                return this.rq.post(url, { username: username, password: password, roles: roles }).pipe(operators.map(( /**
                 * @param {?} res
                 * @return {?}
                 */function (res) {
         ...
         */
            function (accessToken, provider) {
                ...
                return this.rq.post(url, { accessToken: accessToken }).pipe(operators.map(( /**
                 * @param {?} res
                 * @return {?}
                 */function (res) {
                    _this.afterLogin(res);
                 ...
                 */function (res) {
                    _this.session.token = null;
                    return rxjs.throwError(res.json().error);
                })));
            };
        /**
         * @param {?} tenant
         ...
         */
            function () {
                ...
                return this.rq.get(this.broker.getApiUrl() + 'businesslogic/getCurrentSession').pipe(operators.map(( /**
                 * @param {?} res
                 * @return {?}
                 */function (res) {
                    lodashEs.assign(_this.session, res.data);
         ...
         */
            function (email, imageData, password) {
                ...
                return this.rq.post(url, { user: user }).pipe(operators.mergeMap(( /**
                 * @return {?}
                 */function () {
         ...
         */
            function (roles) {
                var _this = this;
                return lodashEs.some(lodashEs.map(roles, ( /**
                 * @param {?} role
                 * @return {?}
         ...
         */
            function (groups) {
                var _this = this;
                return lodashEs.some(lodashEs.map(groups, ( /**
                 * @param {?} group
                 * @return {?}
         ...
         */
            function () {
                return this.session.user && stencil.isPresent(this.session.user.locationRef);
            };
        /**
         * @return {?}
         */
         ...
         */
            function (email, isMagicLink, urlPrefix) {
                if (isMagicLink === void 0) {
                    isMagicLink = false;
                }
                if (urlPrefix === void 0) {
                    urlPrefix = 'https://yoobic.app.link/';
                }
                if (isMagicLink) {
         ...
         */
            function (user, skipAcl, fields) {
                ...
                if (userToUpdate) {
                    ...
                    if (fields && fields.length > 0) {
                        userToUpdate = ( /** @type {?} */(lodashEs.pick(userToUpdate, fields)));
                        if (fields.indexOf('_acl') < 0) {
                            skipAcl = true;
                        }
                    }
                    return this.broker.upsert('user', userToUpdate, null, skipAcl).pipe(operators.flatMap(( /**
                     * @param {?} retVal
                     * @return {?}
                     */function (retVal) {
                        return _this.broker.getById('user', retVal._id).pipe(operators.map(( /**
                         * @param {?} updatedUser
                         * @return {?}
         ...
         */
            function (token, userId) {
                ...
                return this.broker.getById('user', userId).pipe(operators.map(( /**
                 * @param {?} retVal
                 * @return {?}
                 */function (retVal) {
         ...
         */
            function (date) {
                ...
                return this.rq
                    ...
                    date: stencil.toDate(date || new Date()).toISOString()
                })
                    .pipe(operators.map(( /**
             * @param {?} res
             * @return {?}
             */function (res) {
                     ...
                     */function (name) {
                            ...
                            backup.title = stencil.fromNow(stencil.dateParse(dateStr, 'YYYY-MM-DDTHHmmss.sssZ'));
                            backup.badge = stencil.dateFormat(stencil.dateParse(dateStr, 'YYYY-MM-DDTHHmmss.sssZ'), 'L LT');
    ...
    var Blog = /** @class */ (function () {
        function Blog(coreConfig, config, rq, translate$$1) {
            this.coreConfig = coreConfig;
            this.config = config;
            this.rq = rq;
            this.translate = translate$$1;
         ...
         */
            function (blogUrl, limit, skip) {
                ...
                return this.rq.post(url, { url: blogUrl, limit: limit, skip: skip }).pipe(operators.map(( /**
                 * @param {?} retVal
                 * @return {?}
                 */function (retVal) {
                    /** @type {?} */
                     ...
                     */function (b) {
                        try {
                            ...
                            if (b.pubDate && lodashEs.isString(b.pubDate)) {
         ...
         */
            function (blogUrl) {
                /** @type {?} */
                var url = this.config.apiUrl + 'businesslogic/getBlog';
                return this.rq.post(url, { url: blogUrl, limit: 1 }).pipe(operators.map(( /**
                 * @param {?} retVal
                 * @return {?}
                 */function (retVal) {
                    /** @type {?} */
    ...
    var CurrentSessionResolver = /** @class */ (function () {
        ...
        /** @nocollapse */
        CurrentSessionResolver.ctorParameters = function () {
            return [
                { type: Authentication },
                { type: common.Network }
            ];
    ...
    var Dashboard = /** @class */ (function () {
        function Dashboard(broker, translate$$1, session) {
            this.broker = broker;
            this.translate = translate$$1;
            this.session = session;
        }
         ...
         */
             ...
             */function (user) {
                ...
                return this.broker
                    ...
                    where: { originalRef: { inq: [dashboard._id] }, creatorRef: { inq: lodashEs.map(users, '_id') } }
                })
                    .pipe(operators.mergeMap(( /**
             * @return {?}
             */function () {
         ...
         */
            function (dashboard) {
                var _this = this;
                return this.broker.getAll('dashboards', ['_id', '_acl', '_ect', '_lmt'], null, null, [[{ field: 'originalRef', operator: { _id: 'inq' }, value: [dashboard._id] }]], null, 0, -1).pipe(operators.mergeMap(( /**
                 * @param {?} response
                 * @return {?}
                 */function (response) {
                    /** @type {?} */
                     ...
                     * @return {?}
                     */function (d) {
                        d.title = dashboard.title + ' - ' + stencil.dateFormat(new Date(), 'L');
         ...
         */
            function (dashboard, title) {
                /** @type {?} */
                var newDashboard = lodashEs.cloneDeep(dashboard);
                ...
                if (newDashboard.tabs) {
                     ...
                     */function (t) {
                        if (t.items) {
                             ...
                             * @return {?}
                             */function (c) {
                                c.definition._id = stencil.getUUID();
                            }));
                        }
                    }));
                }
         ...
         */
            function (title, filters, collectionName, dateGrouping, groupByDate, timeScale) {
                ...
                if (dateGrouping === void 0) {
                    dateGrouping = 'day';
                }
                if (groupByDate === void 0) {
                    groupByDate = true;
                }
                if (timeScale === void 0) {
                    timeScale = 'last7days';
    ...
    var FilesBroker = /** @class */ (function () {
        ...
        /** @nocollapse */
        FilesBroker.ctorParameters = function () {
            return [
                { type: Dashboard },
                { type: Broker },
                { type: Files }
    ...
    var Googletranslate = /** @class */ (function () {
         ...
         */
            function (query, source, target, rq) {
                ...
                if (sourceLang === targetLang) {
                    ...
                    return rq.post(url, { query: query, sourceLang: sourceLang, targetLang: targetLang }, null, null, null, null, true).pipe(operators.map(( /**
                     * @param {?} response
                     * @return {?}
                     */function (response) {
         ...
         */
            function (query, source, rq) {
                var _this = this;
                /** @type {?} */
                var observables = translate.Translate.availablesLanguage
                    .filter(( /**
             * @param {?} l
             * @return {?}
             ...
             * @return {?}
             */function (l) {
                    return _this.get(query, source, l, rq).pipe(operators.map(( /**
                     * @param {?} value
                     * @return {?}
                     */function (value) {
                        return ({
    ...
    var HttpCustomInterceptor = /** @class */ (function () {
        ...
        /** @nocollapse */
        HttpCustomInterceptor.ctorParameters = function () {
            return [
                { type: Config },
                { type: common.Network },
                { type: common.Log }
    ...
    var PlatformService = /** @class */ (function () {
        function PlatformService(coreConfig) {
            this.coreConfig = coreConfig;
            this.data$ = new rxjs.ReplaySubject(1, 2000);
        }
        /**
         * @param {?} data
         * @return {?}
    ...
    var Locations = /** @class */ (function () {
         ...
         */
            function (position, maxPoints) {
                ...
                return this.broker.getAll('locations', ['_id', 'title', '_geoloc', 'address'], null, null, filters, null, 0, maxPoints).pipe(operators.map(( /**
                 * @param {?} retVal
                 * @return {?}
                 */function (retVal) {
         ...
         */
            function (collectionName, maxPoints, fields, filters, subQuery) {
                ...
                return this.broker.getAll(collectionName, fields || ['_id', 'title', '_geoloc', 'address'], null, null, filters, null, 0, maxPoints, false, subQuery).pipe(operators.map(( /**
                 * @param {?} retVal
                 * @return {?}
                 */function (retVal) {
                    /** @type {?} */
         ...
         */
            function (res, position) {
                 ...
                 * @return {?}
                 */function (location) {
                    if (location._geoloc && position && lodashEs.isNumber(position.latitude) && lodashEs.isNumber(position.longitude)) {
         ...
         */
            function (locationId, nbDays) {
                ...
                if (this.network.isOffline()) {
                    return rxjs.from(this.cache.get(CACHE_KEYS.healthscore, locationId));
                }
                else {
                    /** @type {?} */
                    var url = this.config.apiUrl + 'locations/healthScore?storeId=' + locationId + '&days=[' + nbDays.toString() + ']';
                    return this.rq.get(url).pipe(operators.map(( /**
                     * @param {?} ret
                     * @return {?}
                     */function (ret) {
                        /** @type {?} */
        ...
        /** @nocollapse */
        Locations.ctorParameters = function () {
            return [
                { type: Smartloc },
                { type: Broker },
                { type: Requestor },
    ...
    var Loopback = /** @class */ (function () {
        ...
        /** @nocollapse */
        Loopback.ctorParameters = function () {
            return [
                { type: Session }
            ];
        };
    ...
    var MissionDescriptionCreate = /** @class */ (function (_super) {
        ...
        __decorate([
            Editable('MissionDescription', {
                ...
                flex: 100,
                translate: true,
                values: translate.Translate.availablesLanguageAll,
                clearable: false
            }),
            __metadata("design:type", String)
    ...
    var MissionDescriptionNotifications = /** @class */ (function (_super) {
        ...
        __decorate([
            Editable('MissionDescriptionNotifications', {
                title: 'PDFEXPORT',
                type: stencil.FormFieldType.selectcard,
                translate: true,
                values: [
    ...
    var Scoring = /** @class */ (function (_super) {
        ...
        __decorate([
            Editable('Scoring', { required: true, type: stencil.FormFieldType.text }),
            __metadata("design:type", String)
        ], Scoring.prototype, "title", void 0);
        __decorate([
            Editable('Scoring', { type: stencil.FormFieldType.textarea }),
            __metadata("design:type", String)
        ...
        __decorate([
            Editable('Scoring', { type: stencil.FormFieldType.checkbox, title: 'ISLIVE', columnDefinition: { width: 80 } }),
            __metadata("design:type", Boolean)
    ...
    var Missiondescriptions = /** @class */ (function () {
        ...
        Missiondescriptions.getFormFields = /*
            ...
            */
             ...
             * @return {?}
             */
            function (missiondescription, translate$$1, includeComments) {
                if (includeComments === void 0) {
                 ...
                 */function (previous, current) {
                    /** @type {?} */
                    var retVal = lodashEs.cloneDeep(current);
                    retVal.name += '.value';
                    ...
                    if (current.allowComments && includeComments) {
                        retVal = lodashEs.cloneDeep(current);
                        retVal.title = translate$$1.polyglot(retVal.title) + ' .C';
                        retVal.name += '.comments';
                        retVal.type = stencil.FormFieldType.text;
                        previous.push(retVal);
                    }
                    if (current.allowTime && includeComments) {
                        retVal = lodashEs.cloneDeep(current);
                        retVal.title = translate$$1.polyglot(retVal.title) + ' .T';
                        retVal.name += '.time';
                        retVal.type = stencil.FormFieldType.datetime;
                        previous.push(retVal);
                    }
                    return previous;
                }), []);
                if (missiondescription.type === 'service') {
                    mobileFields.unshift({
                        ...
                        type: stencil.FormFieldType.autocomplete,
                        translate: true,
                        values: lodashEs.uniq(lodashEs.concat(MISSION_STATUS, [undefined])),
                        handleUndefined: true,
                        columnDefinition: { cellRenderer: 'missionStatusRenderer' },
                        operators: Models.getFieldOperator({ type: stencil.FormFieldType.autocomplete })
                    });
                    mobileFields.unshift({
                        name: 'mission.creatorDisplayName',
                        title: 'REQUESTOR',
                        type: stencil.FormFieldType.text,
                        operators: Models.getFieldOperator({ type: stencil.FormFieldType.text })
                    });
                    mobileFields.unshift({
                        name: 'mission._ect',
                        title: 'CREATIONDATE',
                        type: stencil.FormFieldType.datetime,
                        operators: Models.getFieldOperator({ type: stencil.FormFieldType.datetime })
                    });
                }
                if (missiondescription.scoring && missiondescription.scoring.length > 0) {
                    lodashEs.forEach(missiondescription.scoring, ( /**
                     * @param {?} scoring
                     * @return {?}
                     */function (scoring) {
                        if (scoring.isActive !== true) {
                            ...
                            mobileFields.unshift({ name: 'score.value', title: scoring.title, type: stencil.FormFieldType.number });
                        }
                    }));
                }
                return mobileFields;
    ...
    var Print = /** @class */ (function () {
         ...
         */
            function (collectionName, columns, query, subQuery, aggregateOptions, type, campaignFields, filename, progress) {
                ...
                /** @type {?} */
                var exportColumns = lodashEs.sortBy(lodashEs.cloneDeep(columns.filter(( /**
                 * @param {?} c
                 * @return {?}
                ...
                if (campaignFields && campaignFields.length > 0) {
                    /** @type {?} */
                    var catalogs = lodashEs.uniq(campaignFields.filter(( /**
                     * @param {?} f
                     * @return {?}
                     */function (f) { return f.type === stencil.FormFieldType.catalog; })).map(( /**
                     * @param {?} f
                     * @return {?}
                     */function (f) { return f.catalog; })));
                    if (catalogs.length > 0) ;
                    /** @type {?} */
                    var collectionNames = lodashEs.compact(lodashEs.uniq(campaignFields.filter(( /**
                     * @param {?} f
                     * @return {?}
                     */function (f) { return f.type === stencil.FormFieldType.autocomplete; })).map(( /**
                     * @param {?} f
                     * @return {?}
                     */function (f) { return f.collectionName; }))));
                    if (collectionNames.length > 0) ;
                }
                query = lodashEs.cloneDeep(query);
                delete query.fields;
                return this.rq
             ...
             */function (ret) {
                     ...
                     */function (res) {
                            /** @type {?} */
                            var fileUrl = lodashEs.get(res, 'data.output.data.download_url');
                            if (fileUrl) {
                                return stencil.downloadFile(fileUrl, filename);
                            }
                        }));
                    }
                }));
    ...
    var Group = /** @class */ (function (_super) {
        ...
        __decorate([
            Editable('Group', { required: false, type: stencil.FormFieldType.text }),
            Searchable('Group'),
            __metadata("design:type", String)
        ], Group.prototype, "title", void 0);
        __decorate([
            Editable('Group', { required: false, type: stencil.FormFieldType.textarea }),
            Searchable('Group'),
            __metadata("design:type", String)
    ...
    var Security = /** @class */ (function () {
            ...
            function (group, users) {
                ...
                if (group._id) {
                    return this.broker.patch('groups', {
                        _id: group._id,
                        $addToSet: { 'users.list': { $each: lodashEs.map(users, '_id') } }
                    });
                }
                else {
                    //not used
                    group.users.list = lodashEs.uniq(lodashEs.concat(group.users.list, lodashEs.map(users, '_id')));
         ...
         */
            function (group, users) {
                ...
                if (group._id) {
                    return this.broker.patch('groups', {
                        _id: group._id,
                        $pullAll: { 'users.list': lodashEs.map(users, '_id') }
                    });
                }
                else {
                    //not used
                    group.users.list = lodashEs.uniq(lodashEs.difference(group.users.list, lodashEs.map(users, '_id')));
                    return this.broker.create('groups', group);
                }
            };
        /**
         ...
         */
            function (group, groups) {
                ...
                if (group._id) {
                    return this.broker.patch('groups', {
                        _id: group._id,
                        $addToSet: { groups: { $each: lodashEs.map(groups, '_id') } }
                    });
                }
                else {
                    group.groups = lodashEs.uniq(lodashEs.concat(group.groups, lodashEs.map(groups, '_id')));
                    return this.broker.create('groups', group);
                }
            };
        /**
         ...
         */
            function (group, groups) {
                ...
                if (group._id) {
                    return this.broker.patch('groups', {
                        _id: group._id,
                        $pullAll: { groups: lodashEs.map(groups, '_id') }
                    });
                }
                else {
                    group.groups = lodashEs.uniq(lodashEs.difference(group.groups, lodashEs.map(groups, '_id')));
                    return this.broker.create('groups', group);
                }
            };
        /**
         ...
         */
            function (id, addedUsers, removedUsers, addedGroups, removedGroups) {
                var _this = this;
                if (removedUsers === void 0) {
                    removedUsers = [];
                }
                if (addedGroups === void 0) {
                    addedGroups = [];
                }
                if (removedGroups === void 0) {
                    removedGroups = [];
                }
                return this.broker
                    .patch('groups', {
                    _id: id,
                    $pullAll: {
                        'users.list': lodashEs.map(removedUsers, '_id'),
                        groups: lodashEs.map(removedGroups, '_id')
                    }
                })
             ...
             */function () {
                    return _this.broker.patch('groups', {
                        _id: id,
                        $addToSet: {
                            'users.list': { $each: lodashEs.map(addedUsers, '_id') },
                            groups: { $each: lodashEs.map(addedGroups, '_id') }
                        }
                    });
                })));
            };
         ...
         */
             ...
             */function (retVal) {
                    if (mode === 'descendants') {
                        return lodashEs.uniq([].concat(retVal.descendants || []).concat(groupIds || []));
                    }
                    else if (mode === 'ancestors') {
                        return lodashEs.uniq([].concat(retVal.groups || []).concat(groupIds || []));
                    }
                    else if (mode === 'both') {
        ...
        /** @nocollapse */
        Security.ctorParameters = function () {
            return [
                { type: Broker },
                { type: Requestor },
                { type: Config }
    ...
    var Tenants = /** @class */ (function () {
         ...
         */
             ...
             */function (ret) {
                     ...
                     */function (res) {
                            ...
                            /** @type {?} */
                            var data = lodashEs.get(res, 'data.output.data');
        ...
        /** @nocollapse */
        Tenants.ctorParameters = function () {
            return [
                { type: Requestor },
                { type: Broker },
                { type: Config }
    ...
    var Users = /** @class */ (function () {
         ...
         */
            function () {
                ...
                return this.rq.post(url, { host_url: 'support-mobile.operations.yoobic.com' }).pipe(operators.map(( /**
                 * @param {?} res
                 * @return {?}
                 */function (res) {
                    return res;
         ...
         */
            function (username) {
                return this.rq.post(this.broker.getApiUrl() + 'businesslogic/isUsernameTaken', { params: { username: username } }).pipe(operators.map(( /**
                 * @param {?} res
                 * @return {?}
         ...
         */
            function (locationId) {
                return this.broker.getAll('user', Users.simplifiedFields, null, null, [[{ field: 'locationRef', operator: { _id: 'eq' }, value: locationId }]]).pipe(operators.map(( /**
                 * @param {?} res
                 * @return {?}
                 */function (res) { return res.data; })));
            };
         ...
         */
            function (locationId, userTags) {
                ...
                return this.broker.getAllQuery('geofilters', geofilterQuery).pipe(operators.mergeMap(( /**
                 * @param {?} geofilters
                 * @return {?}
                 */function (geofilters) {
                    /** @type {?} */
                    ...
                    userIds = lodashEs.uniq(userIds);
                    /** @type {?} */
                    var userFilter = [[{ field: '_id', operator: { _id: 'inq' }, value: userIds }]];
                    if (userTags && userTags.length > 0) {
                        userFilter[0].push({ field: 'tags', operator: { _id: 'inq' }, value: userTags });
                    }
                    return _this.broker.getAll('user', Users.simplifiedFields, null, null, userFilter).pipe(operators.map(( /**
                     * @param {?} res
                     * @return {?}
                     */function (res) { return res.data; })));
                })));
    ...
    var Version = /** @class */ (function () {
        ...
        /** @nocollapse */
        Version.ctorParameters = function () {
            return [
                { type: Config },
                { type: common.CoreConfig }
            ];
         ...
         */
            function (file) {
                 ...
                 */function (data) {
                    ...
                    /** @type {?} */
                    var retVal = papaparse.parse(csv, { skipEmptyLines: true });
                    return retVal.data;
                }));
                //});
                //});
         ...
         */
            function (file) {
                 ...
                 */function (data) {
                    ...
                    var retVal = [];
                    if (file.name.endsWith('csv')) {
                        retVal.push(papaparse.parse(data, { skipEmptyLines: true }).data);
                    }
                    else {
                        /** @type {?} */
                         ...
                         */function (sheet) {
                            ...
                            retVal.push(papaparse.parse(v, { skipEmptyLines: true }).data);
                        }));
                    }
                    return retVal;
                }));
         ...
         */
            function (title, sheets) {
                 ...
                 */function (s) {
                    ...
                    /** @type {?} */
                    var header = [];
                    lodashEs.forEach(s.data, ( /**
                     * @param {?} d
                     * @return {?}
                     */function (d) {
                        /** @type {?} */
                        var row = [];
                        lodashEs.forEach(s.columns, ( /**
                         * @param {?} c
                         * @return {?}
                         */function (c) {
                            if (!((c.visible === false || c.suppressExport === true || c.action) && c.forceExport !== true)) {
                                /** @type {?} */
                                var value_1 = lodashEs.get(d, c.name);
                                if (c.type === 'address') {
                                ...
                                if (c.type === 'catalog') {
                                    ...
                                    /** @type {?} */
                                    var retVal_1 = '';
                                    lodashEs.keys(value_1).forEach(( /**
                                     * @param {?} pid
                                     * @return {?}
                                     */function (pid) {
                                        /** @type {?} */
                                        var product = lodashEs.find(c.products, ( /**
                                         * @param {?} p
                                         * @return {?}
                                         */function (p) {
                                            return p._id === pid;
                                ...
                                if (c.type === 'date' && value_1) {
                                    /** @type {?} */
                                    var m = stencil.toDate(value_1);
                                    m = stencil.dateAdd(m, 'minutes', stencil.getUTCOffset(m));
                                    value_1 = m;
                                }
                                if (c.type === 'time' && value_1) {
                                    /** @type {?} */
                                    var t = stencil.toDate(value_1);
                                    //t = t.add(t.utcOffset(), 'minutes');
                                    value_1 = stencil.dateFormat(t, 'HH:mm:ss');
                                }
                                if (c.type === 'datetime' && value_1) {
                                    /** @type {?} */
                                    var dt = stencil.toDate(value_1);
                                    //t = t.add(t.utcOffset(), 'minutes');
                                    value_1 = stencil.dateFormat(dt, 'L LT');
                                }
                                if (c.name === '_acl') {
                                ...
                                if (lodashEs.isObject(value_1) && !lodashEs.isDate(value_1) && !lodashEs.isArray(value_1)) {
                                    //&& _isEmpty(value)
                                    value_1 = null;
                                }
                                row.push(value_1);
                ...
                /** @type {?} */
                var filename = title + '-' + stencil.dateFormat(new Date(), 'YYYY-MM-DDTHH:MM') + '.xlsx';
            ...
            function (data, opts) {
                ...
                for (var R = 0; R !== data.length; ++R) {
                    for (var C = 0; C !== data[R].length; ++C) {
                        ...
                        else if (lodashEs.isArray(cell.v) && cell.v.length > 0 && lodashEs.isNumber(cell.v[0])) {
                            cell.t = 's';
                            cell.v = '[' + cell.v.join(',') + ']';
                        }
                        else if (lodashEs.isArray(cell.v) && cell.v.length > 0 && !lodashEs.isNumber(cell.v[0])) {
                        ...
                        else if (lodashEs.isArray(cell.v) && cell.v.length === 0) {
                            cell.t = 's';
                            cell.v = '';
                        }
                        else {
    ...
    var FilterPipe = /** @class */ (function () {
        function FilterPipe(translate$$1) {
            this.translate = translate$$1;
        }
        /**
         * @param {?} value
            ...
            function (value) {
                ...
                if (!args || !args[0]) {
                     ...
                     */function (item) {
                        ...
                        /** @type {?} */
                        var keys = args[1] || lodashEs.keys(item);
                        keys = [].concat(keys);
                        /** @type {?} */
                        var retVal = false;
                        for (var i = 0; i < keys.length; i++) {
                            ...
                            if (args[0] && args[0].toLowerCase) {
                                ...
                                /** @type {?} */
                                var bool = item.hasOwnProperty(key) && !stencil.isBlank(item[key]);
         ...
         * @return {?}
         */
            function (s, translate$$1) {
                if (translate$$1 && this.translate) {
    ...
    var DataCoreModule = /** @class */ (function () {
                ...
                return {
                    ...
                    providers: __spread(SERVICES, configuredProviders, [
                        ...
                        ngx$3.File,
                        {
                            ...
                            deps: [Config, common.Network, common.Log],
                            multi: true
                        }
                    ])
                };
        ...
        DataCoreModule.decorators = [
            { type: core.NgModule, args: [{
                        ...
                        imports: [common.CommonModule, translate.TranslateModule, http.HttpClientModule],
                        exports: __spread([common.CommonModule, translate.TranslateModule, http.HttpClientModule], PIPES)
                    },] }
        ];
    ...
    var Algorithm = /** @class */ (function (_super) {
        ...
        __decorate([
            Editable('Algorithm', { required: true, type: stencil.FormFieldType.text }),
    ...
    var AutorenewConfig = /** @class */ (function (_super) {
        ...
        __decorate([
            Editable('AutorenewConfig', { required: true, type: stencil.FormFieldType.text }),
        ...
        __decorate([
            Editable('AutorenewConfig', { type: stencil.FormFieldType.toggle }),
            Searchable('AutorenewConfig'),
            __metadata("design:type", Boolean)
    ...
    var Backup = /** @class */ (function (_super) {
        ...
        __decorate([
            Editable('Backup', { required: false, type: stencil.FormFieldType.date }),
            __metadata("design:type", Date)
        ], Backup.prototype, "date", void 0);
        __decorate([
            Editable('Backup', { required: true, type: stencil.FormFieldType.autocomplete, clearable: true }),
            __metadata("design:type", Object)
    ...
    var Catalog = /** @class */ (function (_super) {
        ...
        __decorate([
            Editable('Catalog', { required: true, type: stencil.FormFieldType.text }),
            Searchable('Catalog'),
            __metadata("design:type", String)
        ...
        __decorate([
            Editable('Catalog', { type: stencil.FormFieldType.textarea }),
            __metadata("design:type", String)
    ...
    var ChartDefinition = /** @class */ (function (_super) {
        ...
        __decorate([
            Editable('ChartDefinition', {
                type: stencil.FormFieldType.missionfield,
        ...
        __decorate([
            Editable('ChartDefinition', { required: true, type: stencil.FormFieldType.text }),
            Searchable('ChartDefinition'),
            __metadata("design:type", String)
        ], ChartDefinition.prototype, "title", void 0);
        __decorate([
            Editable('ChartDefinition', { required: false, type: stencil.FormFieldType.textarea }),
            Searchable('ChartDefinition'),
            __metadata("design:type", String)
        ...
        __decorate([
            Editable('ChartDefinition', { flex: 33, type: stencil.FormFieldType.checkbox }),
            __metadata("design:type", Boolean)
    ...
    var Currency = /** @class */ (function () {
        ...
        __decorate([
            Editable('Currency', {
                ...
                title: 'LANGUAGE',
                translate: true,
                values: translate.Translate.availablesLanguage,
                clearable: false
            }),
            Searchable('Currency'),
            __metadata("design:type", String)
        ...
        __decorate([
            Editable('Currency', { required: true, type: stencil.FormFieldType.text }),
            Searchable('Currency'),
            __metadata("design:type", String)
        ], Currency.prototype, "symbol", void 0);
        __decorate([
            Editable('Currency', { required: true, type: stencil.FormFieldType.number, title: 'RATE1' }),
            Searchable('Currency'),
            __metadata("design:type", Number)
    ...
    var Dashboard$1 = /** @class */ (function (_super) {
        ...
        __decorate([
            Editable('Dashboard', { required: true, type: stencil.FormFieldType.text, sortable: true }),
            Searchable('Dashboard'),
            __metadata("design:type", String)
        ], Dashboard.prototype, "title", void 0);
        __decorate([
            Editable('Dashboard', { required: false, type: stencil.FormFieldType.textarea }),
            Searchable('Dashboard'),
            __metadata("design:type", String)
    ...
    var File = /** @class */ (function (_super) {
        ...
        __decorate([
            Editable('File', {
                type: stencil.FormFieldType.documentuploader,
                filterable: false,
                required: true,
                title: 'DOCUMENT',
                columnDefinition: { width: 52 },
        ...
        __decorate([
            Editable('File', { title: 'TITLE', required: true, type: stencil.FormFieldType.text, sortable: true }),
            Searchable('File'),
            __metadata("design:type", String)
        ], File.prototype, "_filename", void 0);
        __decorate([
            Editable('File', { visible: false, type: stencil.FormFieldType.number, sortable: true }),
            __metadata("design:type", Number)
        ], File.prototype, "size", void 0);
        __decorate([
            Editable('File', { visible: false, type: stencil.FormFieldType.autocomplete, filterable: true }),
            Searchable('File'),
            __metadata("design:type", String)
        ], File.prototype, "mimeType", void 0);
        __decorate([
            Editable('File', { type: stencil.FormFieldType.toggle, columnDefinition: { width: 80 } }),
            __metadata("design:type", Boolean)
    ...
    var Folder = /** @class */ (function (_super) {
        ...
        __decorate([
            Editable('Folder', { title: 'TITLE', required: true, type: stencil.FormFieldType.text }),
            Searchable('Folder'),
            __metadata("design:type", String)
    ...
    function getStartAndEndDates$1(timescale, endDate, amount, notsliding) {
        /** @type {?} */
        var lastDate = endDate ? stencil.toDate(endDate) : new Date();
        amount = amount || 7;
        /** @type {?} */
        var period = 'days';
        /** @type {?} */
        ...
        //use .utc() to get the startOf with no offset issues
        return [stencil.startOf(stencil.dateAdd(stencil.utc(lastDate), period, -amount), startof).toISOString(), lastDate.toISOString()];
    }
    ...
    var BaseKpi = /** @class */ (function (_super) {
         ...
         */
            function (kpi, showPreviousYear) {
                ...
                if (showPreviousYear) {
                    if (retVal.startDate) {
                        retVal.startDate = stencil.dateAdd(retVal.startDate, 'years', -1).toISOString();
                    }
                    if (retVal.endDate) {
                        retVal.endDate = stencil.dateAdd(retVal.endDate, 'years', -1).toISOString();
                    }
                }
                return retVal;
            };
         ...
         */
            function (filters, dates, field, allowNotExits) {
                ...
                if (dates.startDate || dates.endDate) {
                    ...
                    var filter = void 0;
                    if (allowNotExits) {
                        filters.push(lodashEs.cloneDeep(filters[0]));
        ...
        __decorate([
            Editable('BaseKpi', { tabIndex: 2, tab: 'ADVANCED', type: stencil.FormFieldType.number, advanced: true }),
            __metadata("design:type", Boolean)
    ...
    var Operation = /** @class */ (function (_super) {
        ...
        __decorate([
            Editable('Operation', { type: stencil.FormFieldType.datetime, readonly: true }),
            Searchable('Operation'),
            __metadata("design:type", Date)
        ], Operation.prototype, "_createdAt", void 0);
        __decorate([
            Editable('Operation', { type: stencil.FormFieldType.number, readonly: true }),
            Searchable('Operation'),
            __metadata("design:type", Number)
    ...
    var Product = /** @class */ (function (_super) {
        ...
        __decorate([
            Editable('Product', { required: true, type: stencil.FormFieldType.text, exportOrder: 3, filterable: true, sortable: true }),
            Searchable('Product'),
            __metadata("design:type", String)
        ], Product.prototype, "title", void 0);
        __decorate([
            Editable('Product', { type: stencil.FormFieldType.text, exportOrder: 4, filterable: true, sortable: true }),
            Searchable('Product'),
            __metadata("design:type", String)
        ], Product.prototype, "reference", void 0);
        __decorate([
            Editable('Product', { flex: 50, type: stencil.FormFieldType.text, exportOrder: 10, filterable: true, sortable: true }),
            __metadata("design:type", String)
        ], Product.prototype, "color", void 0);
        __decorate([
            Editable('Product', { required: false, flex: 50, type: stencil.FormFieldType.number, exportOrder: 9 }),
            __metadata("design:type", Number)
        ], Product.prototype, "price", void 0);
        __decorate([
            Editable('Product', { flex: 50, type: stencil.FormFieldType.number, min: 0, exportOrder: 8 }),
            __metadata("design:type", Number)
        ...
        __decorate([
            Editable('Product', { type: stencil.FormFieldType.textarea, exportOrder: 5 }),
            __metadata("design:type", String)
        ], Product.prototype, "description", void 0);
        __decorate([
            Editable('Product', { type: stencil.FormFieldType.textarea, exportOrder: 6 }),
            __metadata("design:type", String)
    ...
    var PublicApiToken = /** @class */ (function (_super) {
        ...
        __decorate([
            Editable('PublicApiToken', { type: stencil.FormFieldType.textarea, readonly: true, name: 'accessToken.id' }),
            __metadata("design:type", Object)
    ...
    var Slide = /** @class */ (function (_super) {
        ...
        __decorate([
            Editable('Slide', { required: true, type: stencil.FormFieldType.text }),
            __metadata("design:type", String)
        ], Slide.prototype, "title", void 0);
        __decorate([
            Editable('Slide', { type: stencil.FormFieldType.textarea }),
            __metadata("design:type", String)
        ], Slide.prototype, "description", void 0);
        __decorate([
            Editable('Slide', { type: stencil.FormFieldType.checkbox, flex: 100, advanced: true }),
            __metadata("design:type", Boolean)
    ...
    var Tableau = /** @class */ (function (_super) {
        ...
        __decorate([
            Editable('Tableau', { type: stencil.FormFieldType.text, required: true, title: 'DASHBOARDID' }),
            Searchable('Tableau'),
            __metadata("design:type", String)
    ...
    var TagGroup = /** @class */ (function (_super) {
        ...
        __decorate([
            Editable('TagGroup', { required: true, type: stencil.FormFieldType.text }),
            Searchable('TagGroup'),
            __metadata("design:type", String)
    ...
    var Todo = /** @class */ (function (_super) {
        ...
        __decorate([
            Editable('Todo', { type: stencil.FormFieldType.text, name: 'title', required: true }),
            __metadata("design:type", String)
        ...
        __decorate([
            Editable('Todo', { type: stencil.FormFieldType.starrating, secondary: true, icon: 'yo-priority' }),
            __metadata("design:type", Number)
    ...
    var TodoTask = /** @class */ (function (_super) {
        ...
        __decorate([
            Editable('TodoTask', { type: stencil.FormFieldType.text, title: 'TITLE', required: true }),
            __metadata("design:type", Object)
        ], TodoTask.prototype, "text", void 0);
        __decorate([
            Editable('TodoTask', { type: stencil.FormFieldType.textarea, required: false }),
            __metadata("design:type", Object)
        ...
        __decorate([
            Editable('TodoTask', { type: stencil.FormFieldType.toggle, required: false, title: 'PHOTO', flex: 50 }),
            __metadata("design:type", Object)
    ...
    function translateButtonHandler(data, field, injector) {
         ...
         */function (values) {
                /** @type {?} */
                var isCapitalized = lodashEs.capitalize(value) === value;
                values.forEach(( /**
                 * @param {?} v
                 * @return {?}
                 */function (v) {
                    data[v.language] = isCapitalized ? lodashEs.capitalize(v.value) : v.value;
                }));
            }));
        }
    }
    ...
    function resetButtonHandler(data, field) {
        translate.Translate.availablesLanguage
            .filter(( /**
     * @param {?} l
     * @return {?}
     */function (l) { return l !== 'key'; }))
    ...
    var Translation = /** @class */ (function (_super) {
        ...
        __decorate([
            Editable('Translation', { required: true, type: stencil.FormFieldType.text }),
        ...
        __decorate([
            Editable('Translation', {
                type: stencil.FormFieldType.button,
                title: 'TRANSLATE',
                color: 'success',
                suppressExport: true,
        ...
        __decorate([
            Editable('Translation', { type: stencil.FormFieldType.toggle, title: 'UNVALIDATEREASON' }),
            __metadata("design:type", Boolean)
        ], Translation.prototype, "isReject", void 0);
        __decorate([
            Editable('Translation', { type: stencil.FormFieldType.toggle, title: 'ANNOTATE' }),
            __metadata("design:type", Boolean)
    ...
    var WorkplaceGroups = /** @class */ (function (_super) {
        ...
        __decorate([
            Editable('WorkplaceGroups', { readonly: true, type: stencil.FormFieldType.text }),
            __metadata("design:type", String)
    ...
    var WorkplacePost = /** @class */ (function (_super) {
        ...
        __decorate([
            Editable('WorkplacePost', { type: stencil.FormFieldType.textarea, required: true }),
            __metadata("design:type", String)
    ...
    var Activity = /** @class */ (function () {
        ...
        /** @nocollapse */
        Activity.ctorParameters = function () {
            return [
                { type: Broker },
                { type: Requestor }
            ];
    ...
    var DataLoader = /** @class */ (function () {
        function DataLoader(broker, collectionName, items, pageSize, translate$$1, translateService, looseCount) {
            if (items === void 0) {
                items = null;
            }
            if (pageSize === void 0) {
            ...
            if (translate$$1 === void 0) {
                translate$$1 = null;
            }
            if (translateService === void 0) {
            ...
            this._items = items;
            this._translate = translate$$1;
            this._looseCount = looseCount;
            if (pageSize && lodashEs.isNumber(pageSize) && pageSize > 0) {
         ...
         */
            function (currentPage, search, filters, sortModel, mapTransform, mapTransformAsync, tag, subQuery, fields, include, aggregateOptions, aggregateOptionsOffline, cacheId, customFilter, includeCount) {
                ...
                if (mapTransform === void 0) {
                    mapTransform = null;
                }
                if (mapTransformAsync === void 0) {
                    mapTransformAsync = false;
                }
                if (tag === void 0) {
                    tag = false;
                }
                ...
                if (aggregateOptions === void 0) {
                    aggregateOptions = null;
                }
                if (aggregateOptionsOffline === void 0) {
                    aggregateOptionsOffline = null;
                }
                if (cacheId === void 0) {
                    cacheId = null;
                }
         ...
         */
            function (start, search, filters, sortModel, mapTransform, mapTransformAsync, tag, subQuery, fields, include, aggregateOptions, aggregateOptionsOffline, cacheId, customFilter, includeCount) {
                ...
                if (search) {
                    return search.pipe(operators.debounceTime(400), operators.distinctUntilChanged(), operators.switchMap(( /**
                     * @param {?} term
                     * @return {?}
         ...
         */
            function (currentPage, search, filters, sortModel, mapTransform, mapTransformAsync, tag, subQuery, fields, include, aggregateOptions, aggregateOptionsOffline, cacheId, customFilter, includeCount) {
                ...
                if ((this._items && this._items.length > 0) || !this._collectionName || lodashEs.isEmpty(this._collectionName)) {
                    /** @type {?} */
                     ...
                     */function (observer) {
                        ...
                        if (sortModel) {
                            data = lodashEs.orderBy(data, sortModel.map(( /**
                             * @param {?} s
                             * @return {?}
                    ...
                    if (mapTransformAsync && mapTransform) {
                        return obs.pipe(operators.mergeMap(( /**
                         * @param {?} res
                         * @return {?}
                ...
                else if (aggregateOptions && lodashEs.isFunction(aggregateOptions)) {
                    if (!mapTransform) {
                        mapTransform = ( /**
                         * @param {?} x
                         * @return {?}
                    ...
                    return this.broker
                        .aggregateQuery(this._collectionName, filters, aggregateOptions(currentPage * this.pageSize, this.pageSize, sortModel, search, filters), search, null, includeCount, cacheId, customFilter, subQuery, aggregateOptionsOffline && lodashEs.isFunction(aggregateOptionsOffline) ? aggregateOptionsOffline(currentPage * this.pageSize, this.pageSize, sortModel, search, filters) : null)
                        .pipe(mapTransformAsync ? operators.mergeMap(( /**
                 * @param {?} res
                 * @return {?}
                 */function (res) { return mapTransform(res, search, filters, currentPage, _this.pageSize); })) : operators.map(( /**
                     * @param {?} res
                     * @return {?}
                     */function (res) { return mapTransform(res, search, filters, currentPage, _this.pageSize); })))
                        .pipe(operators.map(( /**
                 ...
                 */function (retVal) {
                        ...
                        else if (lodashEs.isObject(retVal) && lodashEs.isArray(retVal.data)) ;
                        else {
                            retVal = { data: retVal };
                        }
                    ...
                    /** @type {?} */
                    var retVal = this.broker.getAll(this._collectionName, fields, include, search, filters, sortModel, currentPage * this.pageSize, this.pageSize, tag, subQuery, customFilter, cacheId, this._looseCount, !includeCount).pipe(operators.map(( /**
                     * @param {?} res
                     * @return {?}
                     */function (res) {
                        _this._currentPage = currentPage;
                    ...
                    if (mapTransformAsync && mapTransform) {
                        return retVal.pipe(operators.mergeMap(( /**
                         * @param {?} res
                         * @return {?}
                         */function (res) { return mapTransform(res, search, filters, currentPage, _this.pageSize); })));
                    }
                    else if (mapTransform) {
                        return retVal.pipe(operators.map(( /**
                         * @param {?} res
                         * @return {?}
                         */function (res) { return mapTransform(res, search, filters, currentPage, _this.pageSize); })));
                    }
         ...
         */
            function (search, filters, subQuery, customFilter) {
                ...
                return this.broker.getCount(this._collectionName, search, filters, subQuery, customFilter).pipe(operators.map(( /**
                 * @param {?} ret
                 * @return {?}
                 */function (ret) {
         ...
         */
            function (value) {
                ...
                else if (lodashEs.isEqual(lodashEs.keys(value), ['_id'])) {
    ...
    exports.DataCoreModule = DataCoreModule;
    exports.DashboardCore = Dashboard;
    exports.Editable = Editable;
    exports.Mapping = Mapping;
    exports.Model = Model;
    exports.ModelExtended = ModelExtended;
    exports.Searchable = Searchable;
    exports.AggregateLog = AggregateLog;
    exports.Algorithm = Algorithm;
    exports.AutorenewConfig = AutorenewConfig;
    exports.Backup = Backup;
    exports.CACHE_KEYS = CACHE_KEYS;
    exports.Catalog = Catalog;
    exports.onChartMissionFieldsChange = onChartMissionFieldsChange;
    exports.CHART_TYPES = CHART_TYPES;
    exports.CHART_DATEGROUPINGBY = CHART_DATEGROUPINGBY;
    exports.CHART_SHOW_AS = CHART_SHOW_AS;
    exports.CHART_DATETIMEFORMAT = CHART_DATETIMEFORMAT;
    exports.CHART_TIMESCALE = CHART_TIMESCALE;
    exports.ChartDefinition = ChartDefinition;
    exports.getGroupsTransform = getGroupsTransform;
    exports.isNotInformationField = isNotInformationField;
    exports.getFormFieldValues = getFormFieldValues;
    exports.CONDITION_TYPES = CONDITION_TYPES;
    exports.ROLES = ROLES;
    exports.ROLES_ASK = ROLES_ASK;
    exports.ROLES_CONDITIONS = ROLES_CONDITIONS;
    exports.Condition = Condition;
    exports.ConditionalField = ConditionalField;
    exports.CONDITION_ALL_OPERATORS = CONDITION_ALL_OPERATORS;
    exports.SIMPLE_FIELD_TYPES = SIMPLE_FIELD_TYPES;
    exports.WITH_VALUES_FIELD_TYPES = WITH_VALUES_FIELD_TYPES;
    exports.ADMIN_FILES_TYPE = ADMIN_FILES_TYPE;
    exports.FORMCREATOR_FILES_TYPE = FORMCREATOR_FILES_TYPE;
    exports.FORM_FILES_IMAGE_MIME = FORM_FILES_IMAGE_MIME;
    exports.FORM_FILES_IMAGE_FILTER = FORM_FILES_IMAGE_FILTER;
    exports.FORM_FILES_GROUP_FILTER = FORM_FILES_GROUP_FILTER;
    ...
    exports.Group = Group;
    exports.BaseKpi = BaseKpi;
    exports.LocationType = LocationType;
    exports.onAddressChange = onAddressChange;
    exports.onTypeChange = onTypeChange;
    exports.LOCATION_GEOCODESTATUS = LOCATION_GEOCODESTATUS;
    exports.Location = Location;
    exports.IMapping = IMapping;
    exports.onMissionDescriptionTypeChange = onMissionDescriptionTypeChange;
    exports.MISSION_TYPES_NO_ADMIN = MISSION_TYPES_NO_ADMIN;
    exports.MISSION_TYPES = MISSION_TYPES;
    exports.MISSION_STATUS = MISSION_STATUS;
    exports.MissionDescription = MissionDescription;
    exports.MissionDescriptionCreate = MissionDescriptionCreate;
    exports.MissionDescriptionSchedule = MissionDescriptionSchedule;
    exports.MissionDescriptionNotifications = MissionDescriptionNotifications;
    exports.MissionDescriptionSettings = MissionDescriptionSettings;
    exports.Scoring = Scoring;
    exports.IModel = IModel;
    exports.Notification = Notification;
    exports.Operation = Operation;
    exports.Product = Product;
    exports.PublicApiToken = PublicApiToken;
    ...
    exports.onUserMeActionHandler = onUserMeActionHandler;
    exports.Todo = Todo;
    exports.TodoTask = TodoTask;
    exports.TodoTaskSimple = TodoTaskSimple;
    exports.translateButtonHandler = translateButtonHandler;
    exports.resetButtonHandler = resetButtonHandler;
    exports.Translation = Translation;
    exports.onUserLocationChange = onUserLocationChange;
    exports.User = User;
    exports.UserSettings = UserSettings;
    exports.SimpleUser = SimpleUser;
    exports.WorkplaceGroups = WorkplaceGroups;
    exports.WorkplacePost = WorkplacePost;
    ...
    exports.CurrentSessionResolver = CurrentSessionResolver;
    ...
    exports.Files = Files;
    exports.FilesBroker = FilesBroker;
    exports.Googlemaps = Googlemaps;
    exports.Googletranslate = Googletranslate;
    exports.HttpCustomInterceptor = HttpCustomInterceptor;
    ...
    exports.Missiondescriptions = Missiondescriptions;
    ...
    exports.Xlsx = Xlsx;
    exports.ɵa = getStartAndEndDates$1;

    Object.defineProperty(exports, '__esModule', { value: true });

})));

//# sourceMappingURL=data-core.umd.js.map