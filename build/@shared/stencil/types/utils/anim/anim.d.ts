...
export declare function infiniteLeftSlide(options?: {
...
export declare function leftSlide(options?: {
    startPosition?: number;
    endPosition?: number;
    duration?: number;
    startWidth?: number;
...
export declare function simpleScale(options?: {
    open?: boolean;
    scaleMax?: number;
    scaleMin?: number;
}): {
