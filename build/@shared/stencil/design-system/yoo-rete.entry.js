...
function (_Emitter) {
  ...
  _createClass(Node, [{
    ...
    value: function bindSocket(el, type, io) {
      this.clearSockets();
      this.sockets.set(io, new Socket(el, type, io, this.node, this));
    }
  }, {
    key: "bindControl",
...
function (_Emitter) {
  ...
  _createClass(EditorView, [{
    ...
    value: function addNode(node) {
      ...
      var nodeView = new Node$1(node, component, this);
...
/*!
* rete-connection-plugin v0.5.0-rc.2 
* (c) 2019  
...
function () {
  function Picker(editor) {
    ...
    _defineProperty$1(this, "_output", null);
...
const numSocket = new index.Socket('Number value');
class NumComponent extends index.Component {
    constructor() {
        super('Number');
    }
    builder(node) {
        let out = new index.Output('num', 'Number', numSocket);
        node.addOutput(out);
    ...
    static get style() { return ":host .node-editor {\n  width: 100%;\n  height: 100%; }"; }
}
class YooReteComponent {
    constructor() {
    }
    componentWillLoad() {
    }
...
export { YooReteComponent as YooRete };
