...
import { cB as now, cC as assert } from './chunk-30364fba.js';
...
class YooIonGestureComponent {
    ...
    pointerMove(ev) {
        ...
        const detail = this.detail;
        this.calcGestureData(ev);
        if (this.pan && this.pan.detect(detail.currentX, detail.currentY)) {
    ...
    static get is() { return "yoo-ion-gesture"; }
    static get properties() { return {
        ...
        "gestureCtrl": {
            "connect": "yoo-ion-gesture-controller"
        },
        "gestureName": {
            "type": String,
            "attr": "gesture-name"
...
class YooIonGestureControllerComponent {
    constructor() {
        this.gestureId = 0;
    ...
    static get is() { return "yoo-ion-gesture-controller"; }
    static get properties() { return {
        "create": {
            "method": true
        },
...
export { YooIonGestureComponent as YooIonGesture, YooIonGestureControllerComponent as YooIonGestureController };
