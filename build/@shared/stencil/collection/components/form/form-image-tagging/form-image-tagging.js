import { setValidator, translate, setValueAndValidateInput, querySelectorDeep } from '../../../utils';
import interact from 'interactjs';
import { isNil, isUndefined, shuffle } from 'lodash-es';
...
export class YooFormImageTaggingComponent {
    constructor() {
        this.validators = [];
    ...
    static get style() { return "/**style-placeholder:yoo-form-image-tagging:**/"; }
}
