(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('big.js'), require('rxjs'), require('@angular/common'), require('@angular/router'), require('rxjs/operators'), require('@shared/translate'), require('@voxeet/voxeet-web-sdk'), require('lodash-es'), require('@angular/core'), require('@shared/common'), require('@sentry/browser'), require('@ionic-native/intercom/ngx'), require('@shared/data-core'), require('@shared/stencil')) :
    typeof define === 'function' && define.amd ? define('data-live', ['exports', 'big.js', 'rxjs', '@angular/common', '@angular/router', 'rxjs/operators', '@shared/translate', '@voxeet/voxeet-web-sdk', 'lodash-es', '@angular/core', '@shared/common', '@sentry/browser', '@ionic-native/intercom/ngx', '@shared/data-core', '@shared/stencil'], factory) :
    (factory((global['data-live'] = {}),global.big.js,global.rxjs,global.ng.common,global.ng.router,global.rxjs.operators,global['@shared/translate'],global.VoxeetSdk,global['lodash-es'],global.ng.core,global['@shared/common'],global.Sentry,global.Intercom,global['@shared/data-core'],global.DesignSystem));
}(this, (function (exports,Big,rxjs,common,router,operators,translate,VoxeetSdk,lodashEs,core,common$1,Sentry,ngx,dataCore,stencil) { 'use strict';

    Big = Big && Big.hasOwnProperty('default') ? Big['default'] : Big;
    VoxeetSdk = VoxeetSdk && VoxeetSdk.hasOwnProperty('default') ? VoxeetSdk['default'] : VoxeetSdk;
    ...
    ***************************************************************************** */
    ...
    var Pubnub = /** @class */ (function () {
        function Pubnub(authentication, session, translate$$1, log, push, coreConfig) {
            ...
            this._channels = {};
            this._presenceSubject = new rxjs.Subject();
            this._messageSubject = new rxjs.Subject();
            this._statusSubject = new rxjs.Subject();
         ...
         */
             ...
             * @return {?}
             */function (res) {
                    return lodashEs.includes(res.channels, channel);
                }))
                    .catch(( /**
             * @param {?} err
             * @return {?}
         ...
         */
            function (channel, count, start) {
                ...
                return rxjs.from(this.pubnub.history({ channel: channel, count: count, reverse: false, start: start })).pipe(operators.map(( /**
                 * @param {?} __0
                 * @return {?}
                 */function (_a) {
                    ...
                    return [messages.map(( /**
                             * @param {?} item
                             * @return {?}
                             */function (item) { return lodashEs.merge(item.entry, { timetoken: item.timetoken }); })), startTimeToken, endTimeToken];
                })));
            };
        /**
         * @param {?} channel
         ...
         */
            function (channel, parent) {
                var _this = this;
                /** @type {?} */
                var typing = new rxjs.Subject();
                /** @type {?} */
                var typingSubscription = this._presenceSubject
                    .pipe(operators.filter(( /**
             * @param {?} m
             * @return {?}
             */function (m) { return m.channel === channel && m.uuid !== _this.sender.id; })), operators.map(( /**
                 * @param {?} __0
                 * @return {?}
                 */function (_a) {
                    ...
                    switch (action) {
                        ...
                        case 'join':
                        case 'state-change':
                            return [uuid, lodashEs.isObject(state) && state.isTyping === 'true'];
                    }
                })))
                    .subscribe(typing);
                parent.add(typing);
         ...
         */
            function (channel, withPresence, withTyping) {
                if (withPresence === void 0) {
                    withPresence = false;
                }
                if (withTyping === void 0) {
                    withTyping = false;
                }
                if (!this._channels[channel] || this._channels[channel].subscription.closed) {
                     ...
                     * @param {?} m
                     * @return {?}
                     */function (m) { return m.channel === channel; })), operators.map(( /**
                         * @param {?} m
                         * @return {?}
                         */function (m) { return lodashEs.merge(m.message, { timetoken: m.timetoken }); })))
                            .subscribe(messages);
         ...
         */
            function (channel, text, receiverId, receiverUsername, channels, photo, type, options) {
                ...
                var message = {
                    ...
                    date_sent: new Date(),
                    photo: photo ? ( /** @type {?} */(lodashEs.pick(photo, ['_id', 'value', 'edit', 'texts', 'title', 'name', 'missiondescriptionRef', 'missionRef', 'missiondataRef', 'userRef', 'userDisplayname', 'address']))) : null
                };
         ...
         */
            function (user) {
                ...
                this._presenceSubject = !this._presenceSubject || this._presenceSubject.closed ? new rxjs.Subject() : this._presenceSubject;
                this._messageSubject = !this._messageSubject || this._messageSubject.closed ? new rxjs.Subject() : this._messageSubject;
                this._statusSubject = !this._statusSubject || this._statusSubject.closed ? new rxjs.Subject() : this._statusSubject;
                this._parentSubscription = !this._parentSubscription || this._parentSubscription.closed ? new rxjs.Subscription() : this._parentSubscription;
                this.sender = new PubnubSender(user._id, dataCore.User.getDisplayName(user), user.imageData);
                ...
                /** @type {?} */
                var onlineUsersSubscription = this._presenceSubject.pipe(operators.filter(( /**
                 * @param {?} __0
                 * @return {?}
                 */function (_a) {
        ...
        /** @nocollapse */
        Pubnub.ctorParameters = function () {
            return [
                { type: dataCore.Authentication },
                { type: dataCore.Session },
    ...
    var Channel$1 = /** @class */ (function () {
        function Channel$$1(broker, pubnub, session, translate$$1) {
            this.broker = broker;
            this.pubnub = pubnub;
            this.session = session;
            this.translate = translate$$1;
         ...
         */
            function (channelsId) {
                var _this = this;
                return this.broker.getAll('channels', null, null, null, [[{ field: 'channel', operator: { _id: 'eq' }, value: channelsId }]]).pipe(operators.map(( /**
                 * @param {?} retVal
                 * @return {?}
                 */function (retVal) {
         ...
         */
            function (channelId) {
                var _this = this;
                return this.broker.getAll('channel', null, null, null, [[{ field: 'channel', operator: { _id: 'eq' }, value: channelId }]]).pipe(operators.map(( /**
                 * @param {?} retVal
                 * @return {?}
                 */function (retVal) {
                    if (retVal && retVal.data && retVal.data.length > 0) {
        ...
        Channel$$1.prototype.getFilter =
            ...
            function (user1, user2, isSupport) {
                ...
                if (!isSupport) {
                    usersRef.push({ field: 'usersRef', operator: { _id: 'nin' }, value: dataCore.Users.adminIds });
                }
                 ...
                 */function (res) {
                     ...
                     */function (observer) {
                        if (res.data && res.data.map) {
                            if (!isGroup) {
                                res.data = lodashEs.uniqBy(res.data, 'channel');
                            }
                            channels = res.data
                                .map(( /**
                         * @param {?} channel
                        ...
                        if (channels.length === 0) {
                            ...
                            rxjs.forkJoin(channels.map(( /**
                             * @param {?} channel
                             * @return {?}
                             */function (channel) {
                                return _this.pubnub.getHistory(channel.channel, 1).pipe(operators.map(( /**
                                 * @param {?} retVal
                                 * @return {?}
                                 */function (retVal) {
                                    if (retVal.length > 0) {
                             ...
                             * @return {?}
                             */function (c) {
                                c = lodashEs.orderBy(c, ['lastMessageDate'], ['desc']);
        ...
        /** @nocollapse */
        Channel$$1.ctorParameters = function () {
            return [
    ...
    var WebIntercom = /** @class */ (function () {
        ...
        /** @nocollapse */
        WebIntercom.ctorParameters = function () {
            return [
    ...
    var Intercom = /** @class */ (function () {
        function Intercom(coreConfig, config, intercomNative, authentication, session, webIntercom) {
            ...
            this.unreadCount$ = new rxjs.Subject();
         ...
         */
            function (user) {
                ...
                var traits = {
                    ...
                    createdAt: stencil.unix(stencil.toDate(user._ect)),
    ...
    var Track = /** @class */ (function () {
         ...
         */
             ...
             */function (word) { return word.charAt(0).toUpperCase() + word.slice(1).toLowerCase(); }))
                ...
                if (this.isEnabled() && window.analytics) {
                    try {
                        window.analytics.track(event, lodashEs.merge(this.globalTrackedProps(this.session.user), properties));
                    }
                    catch (error) { }
                }
            };
         ...
         */
            function (name, category, properties) {
                if (this.isEnabled() && window.analytics) {
                    try {
                        window.analytics.page(category, name, lodashEs.merge(this.globalTrackedProps(this.session.user), properties));
                    }
                    catch (error) { }
                }
            };
                        ...
                        if (window.analytics) {
                            try {
                                ...
                                var segment_traits = {
                                    ...
                                    is_dark_theme: common$1.Colors.isDarkTheme()
                                };
                                window.analytics.identify(user._id, lodashEs.merge(_this.globalTrackedProps(user), segment_traits));
                            }
                            catch (error) { }
                        }
         ...
         */
            function (user) {
                ...
                try {
                    ...
                    props = lodashEs.merge(props, { page: router$$1.url });
                }
                catch (err) { }
                return props;
            };
        ...
        /** @nocollapse */
        Track.ctorParameters = function () {
            return [
                { type: common$1.Network },
                { type: dataCore.Push },
                { type: dataCore.Session },
                { type: common$1.LocalStorage },
                { type: dataCore.Authentication },
                { type: common$1.CoreConfig },
                { type: dataCore.Config },
                { type: common$1.Log },
    ...
    var TwilioToken = /** @class */ (function () {
         ...
         */
            function () {
                return this.rq.get(this.config.apiUrl + 'Twilio/getToken').pipe(operators.map(( /**
                 * @param {?} ret
                 * @return {?}
                 */function (ret) {
        ...
        /** @nocollapse */
        TwilioToken.ctorParameters = function () {
            return [
                { type: dataCore.Requestor },
                { type: dataCore.Config }
            ];
    ...
    var VideoCall = /** @class */ (function () {
        function VideoCall(session, log, coreConfig, pubnub, translate$$1) {
            this.session = session;
            this.log = log;
            this.coreConfig = coreConfig;
            this.pubnub = pubnub;
         ...
         */
            function (user) {
                ...
                if (user) {
                    ...
                    if (dataCore.User.getDisplayName(user)) {
                        userName = dataCore.User.getDisplayName(user);
                    }
                    if (user.imageData) {
            ...
            function (conf, options) {
                if (this.useCordova()) {
                    ...
                    return this.voxeet.joinConference(conf.conferenceId ? conf.conferenceId : conf, options || {
                        ...
                        user: {
                            name: dataCore.User.getDisplayName(this.session.user),
         ...
         */
            function (users, roomName, conferenceId) {
                 ...
                 * @return {?}
                 */function (userId) {
                        _this.pubnub.sendChatMessage(userId, _this.translate.get('VIDEOCALLCALLING', { user: dataCore.User.getDisplayName(_this.session.user) }), userId, null, null, null, 'videocall', { conferenceId: conferenceId, user: _this.session.user, users: users });
                    }));
                }
            };
        /**
         ...
         */
            function () {
                var _this = this;
                if (this.voxeet && lodashEs.isFunction(this.voxeet.disconnect)) {
                    this.isInit = false;
         ...
         */
            function () {
                stencil.showAlert(this.translate.get('NOWEBCAM'), [this.translate.get('OK')], null, '');
            };
        /**
         * @return {?}
         */
         ...
         */
            function () {
                stencil.showAlert(this.translate.get('CONFERENCEFAILED'), [this.translate.get('OK')], null, '');
            };
        /**
         * @return {?}
         */
         ...
         */
            function () {
                return stencil.showAlert('', [this.translate.get('OK')], '', this.translate.get('CALLERLEFT'));
            };
        /**
         * @return {?}
         */
         ...
         */
            function () {
                return stencil.showAlert('', [this.translate.get('OK')], '', this.translate.get('RECIEVERLEFT'));
            };
        /**
         * @return {?}
         */
         ...
         */
            function () {
                return stencil.showAlert('', [this.translate.get('OK')], '', this.translate.get('CALLRECORDED'));
            };
        /**
         * @param {?} toast
         * @return {?}
         ...
         */
            function () {
                if (this.videoModal) {
                    stencil.closeModal(this.videoModal);
         ...
         */
            function (data) {
                if (data && data.options && data.sender_id) {
                    this.pubnub.sendChatMessage(data.sender_id, this.translate.get('VIDEOCALLCANCEL', { user: dataCore.User.getDisplayName(this.session.user) }), this.session.user._id, null, null, null, 'videocallcancel', { declineCall: true });
                }
            };
        /**
         * @param {?} users
         ...
         */
            function (users, conferenceId) {
                 ...
                 * @return {?}
                 */function (userId) {
                        _this.pubnub.sendChatMessage(userId, _this.translate.get('VIDEOCALLCANCEL', { user: dataCore.User.getDisplayName(_this.session.user) }), userId, null, null, null, 'videocallcancel', { cancelCall: true });
                    }));
                }
            };
        /**
            ...
            function (data) {
                ...
                if (data && data.options && data.sender_id && this.session.user._id) {
                    if (data.options.declineCall && data.sender_id !== this.session.user._id) {
                        stencil.showAlert('', [this.translate.get('OK')], '', this.translate.get('USERDECLINECALL')).then(( /**
                         * @param {?} res
                         * @return {?}
                         */function (res) {
        ...
        /** @nocollapse */
        VideoCall.ctorParameters = function () {
            return [
                { type: dataCore.Session },
                { type: common$1.Log },
                { type: common$1.CoreConfig },
         ...
         */
            function (configuredProviders) {
                ...
                return {
                    ...
                    providers: __spread(configuredProviders, [Channel$1, Intercom, ngx.Intercom, Messages, Pubnub, SentryErrorHandler, Track, TwilioToken, VideoCall, WebIntercom])
                };
            };
        DataLiveModule.decorators = [
            { type: core.NgModule, args: [{
                        declarations: [],
                        imports: [dataCore.DataCoreModule],
                        exports: [dataCore.DataCoreModule]
                    },] }
        ];
    ...
    var Channels = /** @class */ (function (_super) {
        ...
        __decorate([
            dataCore.Editable('Channels', { required: true, type: stencil.FormFieldType.text }),
            dataCore.Searchable('Channels'),
            __metadata("design:type", String)
        ], Channels.prototype, "name", void 0);
        __decorate([
            dataCore.Editable('Channels', {
                type: stencil.FormFieldType.autocomplete,
    ...
    var Message = /** @class */ (function (_super) {
        ...
        __decorate([
            dataCore.Editable('Message', {
                title: 'TO',
                type: stencil.FormFieldType.emailreport,
                required: true,
                showUsers: true
            }),
            dataCore.Searchable('Message'),
            __metadata("design:type", Array)
        ], Message.prototype, "to", void 0);
        __decorate([
            dataCore.Editable('Message', { title: 'SUBJECT', required: true, type: stencil.FormFieldType.text }),
            dataCore.Searchable('Message'),
            __metadata("design:type", String)
        ], Message.prototype, "title", void 0);
        __decorate([
            dataCore.Editable('Message', { title: 'BODY', required: true, type: stencil.FormFieldType.textarea }),
            __metadata("design:type", String)
        ], Message.prototype, "body", void 0);
        __decorate([
            dataCore.Editable('Message', { title: 'THANKYOU', type: stencil.FormFieldType.text }),
            __metadata("design:type", String)
    ...
    exports.DataLiveModule = DataLiveModule;
    exports.ChannelInterface = Channel;
    exports.Channels = Channels;
    exports.Message = Message;
    exports.Channel = Channel$1;
    exports.Intercom = Intercom;
    exports.WebIntercom = WebIntercom;
    exports.Messages = Messages;
    exports.PubnubSender = PubnubSender;
    exports.Pubnub = Pubnub;
    exports.Track = Track;
    exports.TwilioToken = TwilioToken;
...
//# sourceMappingURL=data-live.umd.js.map